#!/usr/bin/env python3
"""Physics subtopics — Triple Higher (AQA 8463) — 82 subtopics"""
...
"energy": [{'common_mistake': 'STORES are where energy is held (kinetic, chemical, thermal etc.). PATHWAYS are how it moves '
 ...
 {'common_mistake': 'Efficiency = useful output ÷ TOTAL INPUT — not useful ÷ wasted. Result must be ≤ 1 (≤ 100%). If '
  ...
  'higher': 'Describe and evaluate specific methods to increase the efficiency of a given energy transfer — e.g. '
            'lubrication reduces friction losses, streamlining reduces air resistance, thermal insulation reduces heat '
            'loss, LED technology reduces thermal waste in lighting, regenerative braking recovers kinetic energy. '
            'Evaluate cost-effectiveness and practicality of each improvement.',
  'id': 'efficiency',
...
"electricity": [{'common_mistake': 'Ammeters are connected IN SERIES — they must be in the same loop as the component. Voltmeters are '
 ...
 {'common_mistake': 'Only ELECTRONS move when static charge builds up — positive charges do not move. Rubbing makes '
  ...
  'equations': [],
  'fifas': [],
  'higher': 'Explain electrostatic induction: a charged object causes charge separation in a nearby neutral conductor. '
            'Describe applications of static electricity (electrostatic precipitator, inkjet printer, spray painting) '
            'and hazards (fuel tanker discharge, electronic component damage). Explain electric sparks as air '
            'ionisation in strong electric fields.',
  'id': 'static-charge',
 ...
 {'common_mistake': 'Electric field lines go from POSITIVE to NEGATIVE — the direction a positive charge would move. '
  ...
  'equations': ['E = F ÷ q'],
  'fifas': [],
  'higher': 'Represent electric fields using field line diagrams for single charges, pairs of charges, and parallel '
            'plates. Explain the uniform field between parallel plates. Calculate electric field strength: E = F/q. '
            'Describe how field strength varies with distance from a point charge. Link electric field to potential '
            'difference.',
  'id': 'electric-fields',
 ...
 {'common_mistake': 'Temperature in gas law calculations MUST be in KELVIN — not Celsius. Add 273 to convert. 0°C = '
  ...
  'fifas': [{'label': "Boyle's Law",
             ...
             'steps': [('F', "p₁V₁ = p₂V₂ (Boyle's Law — constant temperature)"),
                       ...
                       ('A', 'p₂ = 600 kPa')]}],
  'higher': 'Use the pressure-volume relationship (pV = constant at constant temperature) in calculations. Explain '
            'changes in gas pressure using kinetic theory — increased temperature means higher average KE of '
            'molecules, more frequent and more energetic collisions with walls. Absolute zero (0 K) is the theoretical '
            'temperature at which particles have minimum possible energy.',
...
"atomic-structure": [{'common_mistake': 'The nucleus contains protons AND neutrons — NOT electrons. Electrons orbit the nucleus in shells. '
 ...
 {'common_mistake': 'After each half-life, the activity halves AGAIN from its current value — not from the original. '
  ...
  'fifas': [{'label': 'Half-Life Calculation',
             ...
             'steps': [('F', 'Number of half-lives = total time ÷ half-life; remaining = initial × (½)ⁿ'),
                       ...
                       ('A', 'Activity = 60 Bq')]}],
  'higher': 'Use the concept of half-life to calculate the number of undecayed nuclei or activity remaining after a '
            'given number of half-lives. Explain why half-life cannot be changed by physical or chemical means — it is '
            'a fundamental nuclear property. Compare the suitability of different isotopes for specific uses based on '
            'their half-lives and radiation type.',
  'id': 'half-lives',
 ...
 {'common_mistake': 'Background radiation must be SUBTRACTED before any half-life calculations. Using the uncorrected '
  ...
  'fifas': [],
  'higher': 'Calculate corrected count rates by subtracting background. Evaluate the significance of different '
            'background radiation sources for different occupations (pilots, nuclear workers, radon-affected areas). '
            'Discuss the health implications of radon gas exposure and how it can be mitigated.',
 ...
 {'common_mistake': 'Beta is used for THICKNESS monitoring — not alpha or gamma. Alpha is used for SMOKE detectors — '
  ...
  'equations': [],
  'fifas': [],
  'higher': 'Evaluate the choice of radiation type for specific applications using criteria: penetration, ionisation, '
            'half-life and safety. Calculate the activity remaining after a given time using half-life. Explain why '
            'specific half-lives are chosen for different applications.',
 ...
 {'common_mistake': 'In nuclear fission, the NEUTRON is ABSORBED first, making the nucleus unstable — then it splits. '
  ...
  'fifas': [],
  'higher': 'Explain the chain reaction quantitatively — how one fission produces 2-3 neutrons. Explain critical mass. '
            'Describe the difference between controlled (reactor) and uncontrolled (weapon) chain reactions. Explain '
            'how each reactor component contributes to safe, controlled power production.',
  'id': 'nuclear-fission',
 ...
 {'common_mistake': 'Fusion releases energy because the product nucleus has LESS MASS than the sum of the reactants — '
  ...
  'fifas': [],
  'higher': 'Explain why extremely high temperatures are needed for fusion in terms of Coulomb repulsion between '
            'nuclei. Describe the specific plasma confinement methods (magnetic/laser). Evaluate the advantages of '
            'fusion over fission as a future energy source using quantitative data where available.',
  'id': 'nuclear-fusion',
...
"forces": [{'common_mistake': 'SPEED is scalar, VELOCITY is vector. DISTANCE is scalar, DISPLACEMENT is vector. The most common '
 ...
 {'common_mistake': 'A resultant force of ZERO does NOT mean the object is stationary — it means CONSTANT VELOCITY '
  ...
  'equations': [],
  'fifas': [],
  'higher': 'Resolve forces into components and use vector addition to find resultants of forces at angles (not just '
            'along a line). Describe examples of forces on objects travelling in a circle — centripetal force is '
            'always directed towards the centre. Explain why an object moving in a circle has a constantly changing '
            'velocity (direction changes) even at constant speed, and therefore is accelerating.',
  'id': 'resultant-forces',
 ...
 {'common_mistake': 'When resolving a force, horizontal component uses COS and vertical uses SIN (for angle measured '
  ...
  'triple_only': 'Resolving forces and vector diagrams (HT only) — part of the physics-only extended forces content.',
 ...
 {'common_mistake': 'All forces in a free body diagram act ON the object — not forces the object exerts on others. '
  ...
  'title': 'Free Body Diagrams',
  'triple_only': 'Free body diagrams as a separate topic (HT only) — part of the physics-only extended forces content.',
  'variables': []},
 ...
 {'common_mistake': 'Distance in moments must be the PERPENDICULAR distance from the line of action of the force to '
  ...
  'fifas': [{'label': 'Moment Calculation',
             ...
             'steps': [('F', 'Principle of moments: clockwise moments = anticlockwise moments → F₁ × d₁ = F₂ × d₂'),
                       ...
                       ('A', 'd₂ = 1.5 m')]}],
  'higher': 'Calculate moments and apply the principle of moments to solve equilibrium problems. Solve problems '
            'involving multiple forces and pivots. Calculate gear ratios and predict output speed/force. Explain the '
            'relationship between gear ratio, speed and force (torque).',
 ...
 {'common_mistake': 'Pressure in a fluid acts in ALL DIRECTIONS — not just downwards. P = hρg gives the ADDITIONAL '
  ...
  'higher': "Calculate pressure at depth: P = hρg. Calculate upthrust: F = ρVg. Apply Archimedes' principle to "
            'determine whether objects float or sink. Calculate the fraction of a floating object submerged. Solve '
            'problems involving pressure differences in fluids.',
  ...
  'variables': [('P', 'Pressure', 'pascals', 'Pa'),
                ...
                ('h', 'Depth', 'metres', 'm'),
                ('ρ', 'Density', 'kg/m³', 'kg/m³')]},
 {'common_mistake': 'Upthrust = weight of DISPLACED FLUID — not the weight of the object. A 100 N steel block '
                    'submerged in water experiences upthrust equal to the weight of water it displaces, which is much '
                    'less than 100 N (since steel is denser than water). This is why it sinks — upthrust < weight.',
  'equations': ['Upthrust = ρ_fluid × V_submerged × g'],
  'fifas': [{'label': 'Upthrust Calculation',
             'question': 'A block of volume 0.005 m³ is fully submerged in water (ρ = 1000 kg/m³, g = 10 N/kg). '
                         'Calculate the upthrust.',
             'steps': [('F', 'Upthrust = ρ_fluid × V_submerged × g'),
                       ('I', 'ρ = 1000 kg/m³, V = 0.005 m³, g = 10 N/kg'),
                       ('F', 'Upthrust = 1000 × 0.005 × 10 = 50'),
                       ('A', 'Upthrust = 50 N')]}],
  'higher': "HT only — calculate upthrust using Archimedes' principle. Determine whether objects float or sink by "
            'comparing upthrust with weight. Calculate the fraction of a floating object submerged.',
  'id': 'upthrust-floating',
  'key_note': 'Upthrust = ρ_fluid × V_submerged × g = weight of fluid displaced (Archimedes). Float when upthrust = '
              'weight → density_object < density_fluid. Sink when density_object > density_fluid. Ship: hollow hull '
              'displaces large volume. Submarine: ballast tanks adjust density.',
  'matching': {'instruction': 'Match each scenario to the correct upthrust or floating explanation.',
               'pairs': [('Object with density < water', 'Floats — partially submerged until upthrust equals weight'),
                         ('Object with density > water', 'Sinks — even fully submerged, upthrust < weight'),
                         ('Upthrust calculation', 'ρ_fluid × V_submerged × g = weight of fluid displaced'),
                         ('Submarine rising',
                          'Ballast tanks emptied of water — effective density decreases below seawater')],
               'title': 'Upthrust and Floating'},
  'quiz': [{'opts': [('It sinks — upthrust = 1000 × 0.002 × 10 = 20 N < 30 N weight; net downward force', True),
                     ('It floats — upthrust = 20 N is sufficient to support 30 N', False),
                     ('It hovers — upthrust exactly balances weight', False),
                     ('It rises rapidly — the upthrust of 20 N exceeds the weight', False)],
            'q': 'A 0.002 m³ object is fully submerged in water (ρ = 1000 kg/m³, g = 10 N/kg). Its weight is 30 N. '
                 'What happens to it?',
            'wrong_explanations': {1: '20 N < 30 N means upthrust CANNOT balance weight — the object sinks. It would '
                                      'hover only if upthrust = weight (20 N ≠ 30 N).',
                                   2: 'Upthrust of 20 N does NOT equal weight of 30 N — the object sinks.',
                                   3: 'For rising, upthrust > weight — here upthrust (20 N) < weight (30 N), so it '
                                      'sinks.'}},
           {'opts': [('89.5% — ratio of densities: 917/1025 = 0.895 = 89.5% submerged', True),
                     ('10.5% — only the visible part above water is relevant', False),
                     ('50% — objects always float half submerged', False),
                     ('100% — icebergs are fully submerged because ice is denser than water', False)],
            'q': 'What fraction of a floating iceberg is below water? (Density of ice = 917 kg/m³, seawater = 1025 '
                 'kg/m³)',
            'wrong_explanations': {1: '10.5% is the fraction ABOVE water — the fraction BELOW is 89.5%.',
                                   2: 'Only objects with exactly half the density of the fluid float half submerged — '
                                      'fraction submerged = density_object/density_fluid.',
                                   3: 'Ice (917 kg/m³) is LESS dense than seawater (1025 kg/m³) — it floats. 89.5% is '
                                      'below the surface.'}}],
  'rp': None,
  'spec': '6.5.5.1.2 (HT only)',
  'summary': "Explain upthrust using pressure differences and apply Archimedes' principle to floating.",
  'theory': [{'content': 'UPTHRUST is the upward force on an object submerged in a fluid.\n'
                         '\n'
                         'CAUSE:\n'
                         ...
                         'A denser object displaces less volume before sinking — if density > fluid, it fully '
                         'submerges and still sinks (upthrust < weight).',
  ...
  'title': 'Upthrust and Floating',
  'triple_only': 'Upthrust and floating in detail (HT only) — part of the physics-only pressure in fluids topic.',
  'variables': [('U', 'Upthrust', 'newtons', 'N'),
                ('ρ', 'Density of fluid', 'kg/m³', 'kg/m³'),
                ('V', 'Volume submerged', 'm³', 'm³'),
                ('g', 'Gravitational field strength', 'N/kg', 'N/kg')]},
 {'common_mistake': 'Speed is scalar (magnitude only). Velocity is vector (magnitude AND direction). A car travelling '
  ...
  'higher': 'Explain qualitatively that circular motion involves constant speed but changing velocity — the direction '
            'changes continuously, so the object is always accelerating towards the centre. This centripetal '
            'acceleration is caused by a centripetal force directed towards the centre of the circle.',
 ...
 {'common_mistake': 'A FLAT (horizontal) section means the object is STATIONARY — not moving at constant speed. '
  ...
  'fifas': [{'label': 'Speed from d–t Graph',
             ...
             'steps': [('F', 'Speed = gradient = Δd ÷ Δt'),
                       ...
                       ('F', 'Speed = 60 ÷ 12'),
                       ('A', 'Speed = 5 m/s')]}],
  'higher': 'Calculate the instantaneous speed of an accelerating object at a specific time by drawing a tangent to '
            'the curve at that point on a distance–time graph and calculating its gradient. Distinguish between '
 ...
 {'common_mistake': 'Gradient of a v–t graph = ACCELERATION (not distance or speed). Area under a v–t graph = '
  ...
  'fifas': [{'label': 'Acceleration',
             ...
             'steps': [('F', 'a = (v − u) ÷ t'),
                       ...
                       ('F', 'a = (50 − 0) ÷ 25 = 50 ÷ 25'),
                       ('A', 'a = 2 m/s²')]}],
  'higher': 'Use the equations of motion quantitatively including v² = u² + 2as. Estimate the speed, acceleration or '
            'distance for situations including everyday transport. Interpret velocity-time graphs to find: '
            'acceleration from gradient, distance from area under the graph (trapezium or triangle calculation).',
  'id': 'acceleration',
 ...
 {'common_mistake': "Newton's Third Law pairs act on DIFFERENT objects — they cannot cancel. When a horse pulls a cart "
  ...
  'fifas': [{'label': "Newton's Second Law",
             ...
             'steps': [('F', 'F = m × a, so a = F ÷ m'),
                       ...
                       ('F', 'a = 2700 ÷ 900'),
                       ('A', 'a = 3 m/s²')]}],
  'higher': "Apply Newton's Second Law in the form F = ma to multi-step problems including objects on slopes and "
            'systems with multiple forces. Explain inertial mass: the ratio of force to acceleration (F/a) — a measure '
            "of how difficult it is to change an object's velocity. Distinguish inertial mass from gravitational mass.",
  'id': 'newtons-laws',
 ...
 {'common_mistake': 'Braking distance ∝ v² — doubling speed QUADRUPLES braking distance (not doubles). Thinking '
  ...
  'higher': 'Explain the danger of large decelerations: F = Δp/Δt — hard braking produces very large deceleration '
            'forces on passengers which can cause injury. Explain why worn tyres increase braking distance — reduced '
            'tread depth decreases water dispersal, reducing friction. Evaluate the relationship between deceleration '
            'and the risk of injury in vehicle collisions.',
 ...
 {'common_mistake': 'An object in circular motion at constant SPEED is NOT in equilibrium — it IS accelerating '
  ...
  'triple_only': 'Motion in a circle (HT only) — part of the physics-only extended forces and space physics content.',
  'variables': []},
 {'common_mistake': 'Momentum is a VECTOR — direction matters. When objects move in opposite directions, one momentum '
  ...
  'equations': ['p = m × v', 'Conservation: total p before = total p after', 'Impulse: F × t = Δp'],
  'fifas': [{'label': 'Conservation of Momentum',
             'question': 'A 600 kg car travelling at 15 m/s collides with a stationary 400 kg car. They stick '
                         'together. Find their velocity after the collision.',
             'steps': [('F', 'Total p before = total p after: m₁v₁ + m₂v₂ = (m₁+m₂)v'),
                       ('I', 'p before = (600 × 15) + (400 × 0) = 9000 kg m/s'),
                       ('F', '9000 = (600 + 400) × v = 1000v'),
                       ('A', 'v = 9000 ÷ 1000 = 9 m/s')]}],
  'higher': None,
  'id': 'momentum',
  'key_note': 'p = mv. Vector — direction matters. Conservation: total p before = total p after (closed system). '
              'Applies to collisions and explosions. Impulse: F = Δp/t. Longer collision time → smaller force. Safety: '
              'crumple zones, airbags, seat belts, helmets all increase collision time.',
  'matching': {'instruction': 'Match each scenario to the correct momentum or velocity.',
               'pairs': [('20,000 kg m/s', '1000 kg car at 20 m/s — p = 1000 × 20'),
                         ('5.56 m/s', '1000 kg + 800 kg after collision (p = 10,000 kg m/s) — v = 10000/1800'),
                         ('Crumple zones', 'Increase collision time → reduce peak force — same impulse, longer time'),
                         ('Zero', 'Total momentum before an explosion — object was stationary')],
               'title': 'Momentum Calculations'},
  'quiz': [{'opts': [('2 m/s — p before = 0.5 × 8 = 4 kg m/s; (0.5+1.5)v = 4; v = 4/2 = 2 m/s', True),
                     ("4 m/s — using only the moving ball's mass: 4/0.5 = 8... wrong rearrangement", False),
                     ('8 m/s — velocity is conserved, not momentum', False),
                     ('0 m/s — the stationary ball stops the moving one', False)],
            'q': 'A 0.5 kg ball moving at 8 m/s collides with a stationary 1.5 kg ball. They stick together. What is '
                 'their combined velocity?',
            'wrong_explanations': {1: 'p = 4 kg m/s. After: (0.5+1.5)v = 4; 2v = 4; v = 2 m/s — not 4 (uses wrong '
                                      'total mass).',
                                   2: 'Velocity is NOT conserved — MOMENTUM is conserved. Speed always decreases when '
                                      'objects stick together.',
                                   3: "The stationary ball doesn't have enough momentum to stop the moving one — "
                                      'momentum must balance.'}},
           {'opts': [('They increase the time of the collision, reducing the peak force on passengers for the same '
                      'change in momentum',
                      True),
                     ('They reduce the total momentum change — less deceleration occurs', False),
                     ('They absorb all kinetic energy — no force is transmitted to the passenger compartment', False),
                     ('They make the car lighter — less mass means less momentum and a gentler stop', False)],
            'q': 'Why do modern cars have crumple zones at the front?',
            'wrong_explanations': {1: 'The momentum change (impulse) is the same — the car still goes from moving to '
                                      'stationary. Crumple zones increase TIME, not reduce the impulse.',
                                   2: "Crumple zones don't absorb ALL kinetic energy without any force — they spread "
                                      'the energy absorption over a longer time to reduce peak force.',
                                   3: 'Crumple zones add mass (metal structure) — the mass reduction argument is not '
                                      'the mechanism.'}}],
  'rp': None,
  'spec': '6.5.5.1–6.5.5.2',
  'summary': 'Define momentum, calculate it using p = mv and apply conservation of momentum to collisions.',
  'theory': [{'content': 'MOMENTUM is a property of any moving object — it depends on both mass and velocity.\n'
                         '\n'
                         'EQUATION:\n'
                         'p = m × v\n'
                         '\n'
             ...
             {'content': 'IMPULSE — changing momentum requires a force:\n'
                         ...
                         '\n'
                         'SAFETY APPLICATIONS:\n'
                         'CRUMPLE ZONES: car crushes slowly on impact → increases time of collision → reduces peak '
                         'force on occupants.\n'
                         'SEAT BELTS: stretch slightly → increase time for passenger to decelerate → reduce peak '
                         'force.\n'
                         "AIR BAGS: passenger's head decelerates into cushion of air → longer time → smaller force on "
                         'head.\n'
                         ...
                         '\n'
                         'All use the same principle: Δp is fixed (same change in momentum needed) — increasing time '
                         'reduces the force.',
              'heading': 'Momentum, Force and Safety'}],
  'title': 'Momentum',
  'triple_only': None,
  'variables': [('p', 'Momentum', 'kg m/s', 'kg m/s'),
                ('m', 'Mass', 'kilograms', 'kg'),
                ('v', 'Velocity', 'm/s', 'm/s')]}],
...
"waves": [{'common_mistake': 'In a TRANSVERSE wave, the oscillation is PERPENDICULAR to the direction of travel — not parallel. '
  ...
  'triple_only': None,
  'variables': []},
 {'common_mistake': 'In sonar/ultrasound calculations, divide the time by 2 because the pulse travels TO the boundary '
                    'AND BACK. Using the full time gives double the actual distance. Sound travels FASTER in denser '
                    'media (solid > liquid > gas) — opposite to EM waves.',
  'equations': ['d = v × t / 2  (distance to reflecting surface)'],
  'fifas': [{'label': 'SONAR Distance',
             'question': 'A ship sends an ultrasound pulse. The echo returns after 0.06 s. Speed of sound in water = '
                         '1500 m/s. Calculate the depth of the seabed.',
             'steps': [('F', 'd = v × t / 2'),
                       ('I', 'v = 1500 m/s, t = 0.06 s'),
                       ('F', 'd = 1500 × 0.06 / 2 = 90 / 2'),
                       ('A', 'd = 45 m')]}],
  'higher': 'HT only — calculate distance using d = vt/2. Explain why ultrasound is preferred over X-rays for soft '
            'tissue scanning. Describe echolocation and SONAR applications quantitatively.',
  'id': 'sound-waves-hearing',
  'key_note': 'Sound: longitudinal, mechanical, needs medium. Human range: 20 Hz–20 kHz. Infrasound <20 Hz, ultrasound '
              '>20 kHz. Speed: solid > liquid > gas. Ultrasound uses: medical scanning, SONAR, non-destructive '
              'testing. d = v × t/2 (divide by 2 for return journey).',
  'matching': {'instruction': 'Match each application to the correct sound wave type and use.',
               'pairs': [('SONAR depth sounding', 'Ultrasound pulse reflected from seabed — d = vt/2'),
                         ('Foetal scanning', 'Ultrasound — safe (non-ionising), images soft tissues'),
                         ('Bat echolocation', 'Ultrasound emitted and detected — locate insects and navigate'),
                         ('Elephant communication', 'Infrasound — below 20 Hz, travels long distances')],
               'title': 'Sound and Ultrasound'},
  'quiz': [{'opts': [('The pulse travels to the reflecting surface AND back — the total time is twice the one-way '
                      'travel time',
                      True),
                     ('Ultrasound travels at half the speed of normal sound in water', False),
                     ('Only half the energy of the pulse returns as an echo — the rest is absorbed', False),
                     ('There is always a 50% delay at the reflecting surface before the echo returns', False)],
            'q': 'Why must you divide the echo time by 2 in SONAR calculations?',
            'wrong_explanations': {1: "Ultrasound speed doesn't change by a factor of 2 — the factor of 2 accounts for "
                                      'the return journey distance.',
                                   2: 'Energy loss affects amplitude, not the time calculation for distance.',
                                   3: 'There is no fixed time delay at the surface — the factor of 2 is purely '
                                      'geometric (distance there and back).'}},
           {'opts': [("Ultrasound is non-ionising — it doesn't damage cells or DNA like X-rays can; it's safe for the "
                      'developing baby',
                      True),
                     ...
                     ('X-rays cannot penetrate soft tissue — ultrasound is the only option for soft tissue imaging',
                      False),
                     ('Ultrasound is cheaper and faster than X-ray equipment', False)],
  ...
  'rp': None,
  'spec': '6.6.1.4 (HT only, physics only)',
  'summary': 'Describe sound wave properties and explain the range of human hearing and ultrasound.',
  'theory': [{'content': 'SOUND WAVES are longitudinal mechanical waves — compressions and rarefactions travel through '
                         'a medium.\n'
                         '\n'
  ...
  'triple_only': 'Sound waves and hearing (HT only, physics only) — not in Combined Science.',
  'variables': [('d', 'Depth/distance', 'metres', 'm'),
                ('v', 'Speed of sound in medium', 'm/s', 'm/s'),
                ('t', 'Time for echo to return', 'seconds', 's')]},
 {'common_mistake': "S-waves cannot travel through LIQUIDS — this is the key evidence that Earth's outer core is "
                    'liquid. P-waves can travel through both solids and liquids. Seismic waves travel in curved paths '
                    'through the Earth because their speed changes gradually with depth (refraction).',
  'equations': ['d = v × t / 2  (echo sounding depth calculation)'],
  'fifas': [],
  'higher': "HT only — use seismic wave data to infer Earth's internal structure. Explain the difference between P and "
            "S waves and why S-waves don't pass through the outer core. Calculate depths from echo sounding data.",
  'id': 'waves-detection-exploration',
  'key_note': 'P-waves: longitudinal, solid + liquid. S-waves: transverse, solid only. S-waves blocked by outer core → '
              'outer core = liquid. Echo sounding: d = vt/2. Seismic surveying: find oil layers. Refraction at '
              'boundaries: wave changes speed → changes direction.',
  'matching': {'instruction': 'Match each wave type to its properties and what it can travel through.',
               'pairs': [('P-waves (Primary)',
               ...
               'title': 'Seismic Waves'},
  'quiz': [{'opts': [('Earth has a liquid outer core — S-waves cannot travel through liquids, so they are blocked',
                      True),
                     ('S-waves are too weak to travel to the opposite side of the Earth', False),
                     ('S-waves are absorbed by the mantle before reaching the outer core', False),
                     ('The opposite side of the Earth is too far — all wave types have a maximum range', False)],
            'q': 'After a distant earthquake, S-waves are not detected on the opposite side of Earth. What does this '
                 'indicate?',
            'wrong_explanations': {1: 'S-waves lose energy over distance, but can still be detected across Earth if '
                                      'the path is clear — the specific S-wave shadow zones indicate a LIQUID barrier.',
                                   2: 'S-waves do attenuate, but the pattern of shadow zones is specifically '
                                      'consistent with a liquid outer core, not general distance attenuation.',
                                   3: "P-waves ARE detected on the opposite side — so 'too far' doesn't apply. The "
                                      'distinction between P and S wave shadows points to the liquid core '
                                      'explanation.'}},
           {'opts': [('300 m — d = 1500 × 0.4 / 2 = 600 / 2 = 300 m', True),
                     ('600 m — d = 1500 × 0.4 = 600 m (forgot to divide by 2)', False),
                     ('3750 m — d = 1500 / 0.4 = 3750 m (divided instead of multiplied)', False),
                     ('150 m — d = 1500 × 0.4 / 4 = 150 m', False)],
            'q': 'A ship sends a sonar pulse and receives the echo 0.4 s later. Speed of sound in water = 1500 m/s. '
                 'What is the water depth?',
            'wrong_explanations': {1: "600 m doesn't account for the return journey — the pulse travels TO the seabed "
                                      'AND back, so divide total time by 2.',
                                   2: 'Speed divided by time gives a rate of change of speed, not distance — use d = v '
                                      '× t / 2.',
                                   3: "There's no physical reason to divide by 4 — divide by 2 for the two-way "
                                      'journey.'}}],
  'rp': None,
  'spec': '6.6.1.5 (HT only, physics only)',
  'summary': 'Describe how waves are used for detection and exploration including seismic waves and echo sounding.',
  'theory': [{'content': 'SEISMIC WAVES are produced by earthquakes (or explosions) and travel through the Earth.\n'
                         '\n'
                         'TWO MAIN TYPES:\n'
                         ...
                         'S-wave shadow zone: region directly opposite the earthquake (S-waves blocked by liquid '
                         'core).\n'
                         'P-wave shadow zone: P-waves refracted by core → gaps in coverage.',
              'heading': 'Seismic Waves'},
             {'content': 'ECHO SOUNDING uses reflected sound (or ultrasound) pulses to measure depth and map the '
                         'seabed.\n'
                         '\n'
                         'PRINCIPLE:\n'
             ...
             {'content': 'Different substances may ABSORB, TRANSMIT, REFRACT or REFLECT waves — in ways that vary with '
                         'wavelength.\n'
                         '\n'
                         'REFRACTION:\n'
  ...
  'title': 'Waves for Detection and Exploration',
  'triple_only': 'Waves for detection and exploration (HT only, physics only) — not in Combined Science.',
  'variables': []},
 ...
 {'common_mistake': 'When light enters glass from air, it SLOWS DOWN and bends TOWARDS the normal (angle of refraction '
  ...
  'equations': [],
  'fifas': [],
  'higher': 'Explain refraction in terms of the change in wave speed at a boundary — when a wave slows it bends '
            'towards the normal. Describe total internal reflection (TIR): when light in a denser medium hits a '
            'boundary at an angle greater than the critical angle, all light reflects internally. Critical angle: '
            'sin(c) = 1/n. Applications: optical fibres, endoscopes, diamond cut.',
 ...
 {'common_mistake': 'UV, X-rays and gamma rays are all IONISING — they can damage DNA. Infrared and visible light can '
  ...
  'equations': [],
  'fifas': [],
  'higher': 'Explain how radio waves are produced by oscillations in electrical circuits and can induce alternating '
            'currents at the same frequency when absorbed. Describe how different types of electromagnetic radiation '
            'are produced and detected: gamma from nuclear decay, X-rays from electron deceleration, UV from very hot '
            'objects, IR from all objects above absolute zero.',
 ...
 {'common_mistake': 'MRI scanners use RADIO WAVES (not X-rays) — they are safe for soft tissue imaging with no '
  ...
  'equations': [],
  'fifas': [],
  'higher': 'Explain why different wavelengths of EM radiation are used for different applications in terms of their '
            'properties — penetration, absorption, reflection and refraction behaviour. Evaluate the hazards and '
            'benefits of each type in context (e.g. X-rays vs MRI vs ultrasound for medical imaging). Explain how '
            'optical fibres work using total internal reflection.',
  'id': 'uses-em-waves',
 ...
 {'common_mistake': 'During refraction, FREQUENCY stays constant — only SPEED and WAVELENGTH change. v = fλ, so if v '
  ...
  'triple_only': 'Wave front diagrams and radio wave production (HT only, physics only) — not in Combined Science.',
  'variables': []},
 {'common_mistake': 'A converging lens does NOT always form a real image. If the object is inside the focal length, it '
  ...
  'fifas': [],
  'higher': 'Draw accurate ray diagrams for converging and diverging lenses for objects at various positions. '
            'Calculate magnification from image and object distances. Explain short-sightedness and long-sightedness '
            'and how each is corrected. Describe the eye as an optical instrument.',
  'id': 'lenses',
 ...
 {'common_mistake': 'A PERFECT BLACK BODY is black because it absorbs ALL radiation — it also emits MAXIMUM radiation '
  ...
  'equations': [],
  'fifas': [],
  'higher': "Explain black body radiation curves — how peak wavelength depends on temperature. Describe how Earth's "
            'radiation balance determines its temperature. Explain the greenhouse effect mechanistically. Evaluate how '
            "changes in albedo or greenhouse gas concentration affect Earth's temperature.",
  ...
  'variables': []},
 {'common_mistake': 'Earth emits INFRARED radiation — not the same as the visible light from the Sun. Greenhouse gases '
                    'absorb INFRARED (outgoing from Earth) not visible light (incoming from Sun). The natural '
                    'greenhouse effect is beneficial — without it, Earth would be too cold for life. The ENHANCED '
                    'greenhouse effect from human emissions is the problem.',
  'equations': [],
  'fifas': [],
  'higher': 'HT only — explain how radiation balance determines temperature. Explain the greenhouse effect '
            'mechanistically — why greenhouse gases warm Earth. Evaluate the effects of increasing greenhouse gas '
            "concentrations on Earth's radiation balance and temperature.",
  'id': 'radiation-balance-temperature',
  'key_note': 'Radiation balance: absorbed energy = emitted energy → constant temperature. Earth absorbs solar '
              '(visible), emits IR. Greenhouse gases absorb outgoing IR → re-emit → warming. Natural greenhouse: '
              'necessary (without it, −18°C). Enhanced: human emissions increase warming. Factors: solar intensity, '
              'albedo, greenhouse gas concentration.',
  'matching': {'instruction': 'Match each statement to the correct radiation balance concept.',
               'pairs': [('Absorbed > emitted', 'Object temperature rises — radiation imbalance causing warming'),
                         ('Absorbed = emitted', 'Object at constant temperature — thermal equilibrium'),
  ...
  'quiz': [{'opts': [('Greenhouse gases are transparent to visible light but absorb infrared — the molecular '
                      'vibrations of CO₂ and H₂O match infrared wavelengths, not visible wavelengths',
                      True),
                     ('Visible light is reflected by greenhouse gases — infrared passes straight through', False),
                     ('Greenhouse gases are only found high in the atmosphere where solar radiation has already been '
                      'absorbed',
                      False),
                     ('Visible light is too energetic for greenhouse gases to absorb — only lower-energy IR is '
                      'absorbed',
                      False)],
            'q': 'Why do greenhouse gases absorb outgoing infrared from Earth but not incoming solar visible light?',
            'wrong_explanations': {1: "Greenhouse gases TRANSMIT visible light (that's how sunlight reaches Earth's "
                                      "surface) — they don't reflect it.",
                                   2: 'Greenhouse gases are distributed throughout the lower atmosphere — and they '
                                      'specifically absorb IR due to molecular vibration modes.',
                                   3: 'Visible light photons have higher energy than IR — but the absorption depends '
                                      'on RESONANCE with molecular vibrational frequencies, not energy level alone. '
                                      "CO₂ simply doesn't have vibrational modes that match visible frequencies."}},
           {'opts': [('About −18°C — without greenhouse gas insulation, Earth would radiate enough heat to space to '
                      'maintain a much colder equilibrium',
                      True),
                     ("The same as now (~15°C) — the greenhouse effect has no significant effect on Earth's "
                      'temperature',
                      False),
                     ('Over 100°C — greenhouse gases cool Earth by reflecting solar radiation back to space', False),
                     ('0°C — the greenhouse effect raises temperature exactly 15°C above the freezing point', False)],
            'q': "Without any greenhouse effect, what would Earth's average temperature be?",
            'wrong_explanations': {1: "The greenhouse effect raises Earth's temperature by ~33°C — from −18°C to "
                                      '+15°C. It has a very significant effect.',
                                   2: "Greenhouse gases WARM Earth by trapping outgoing IR — they don't cool it by "
                                      'reflecting solar radiation.',
                                   3: '0°C is not a physically derived number — the equilibrium temperature without '
                                      'greenhouse gases is calculated to be about −18°C based on solar input and '
                                      "Earth's albedo."}}],
  'rp': None,
  'spec': '6.6.5.4 (HT only)',
  'summary': "Explain how radiation balance determines the Earth's temperature and the greenhouse effect.",
  'theory': [{'content': 'The TEMPERATURE of any object, including Earth, is determined by the BALANCE between '
                         ...
                         'Earth absorbs solar radiation → warms up → emits infrared (longer wavelength — Earth is much '
                         'cooler than Sun).\n'
              ...
              'heading': 'Radiation Balance'},
             {'content': 'GREENHOUSE GASES (CO₂, H₂O, CH₄) in the atmosphere absorb outgoing infrared radiation.\n'
                         '\n'
                         'NATURAL GREENHOUSE EFFECT:\n'
                         "Sun emits visible light → passes through atmosphere (not absorbed) → absorbed by Earth's "
                         'surface → Earth warms → emits infrared.\n'
                         'Infrared partially absorbed by greenhouse gases → atmosphere warms → re-emits radiation in '
                         ...
                         '\n'
                         'ENHANCED GREENHOUSE EFFECT:\n'
                         'Human activities increase concentrations of greenhouse gases (burning fossil fuels → CO₂; '
                         'livestock → CH₄).\n'
             ...
             {'content': "FACTORS AFFECTING EARTH'S TEMPERATURE:\n"
                         '\n'
                         '1. SOLAR INTENSITY: distance from Sun → amount of solar radiation reaching Earth.\n'
                         "2. ALBEDO: reflectivity of Earth's surface (ice and snow reflect more; oceans and forests "
                         'absorb more).\n'
                         ...
                         'VENUS: similar distance to Earth but thick CO₂ atmosphere → 465°C (extreme greenhouse '
                         'effect).\n'
                         ...
                         'Earth (~15°C) → infrared.\n'
                         'This wavelength difference is why greenhouse gases (which absorb IR but not visible) are key '
                         'to climate.',
              'heading': "Earth's Temperature and Radiation"}],
  'title': "Radiation Balance and Earth's Temperature",
  'triple_only': "Radiation balance and Earth's temperature (HT only, physics only) — not in Combined Science as a "
                 'quantitative topic.',
  'variables': []}],
...
"magnetism": [{'common_mistake': 'Only IRON, STEEL, NICKEL and COBALT are magnetic materials. Aluminium and copper are NOT '
 ...
 {'common_mistake': 'An electromagnet uses IRON (soft) — not steel (hard). Iron demagnetises when the current is '
  ...
  'equations': [],
  'fifas': [],
  'higher': 'Describe the motor effect: a current-carrying conductor in a magnetic field experiences a force F = BIl. '
            "Apply Fleming's Left-Hand Rule to determine force direction. Explain how the motor effect is used in "
            'loudspeakers. Describe electromagnetic induction (generator effect): a conductor moving in a magnetic '
            "field induces an EMF — Fleming's Right-Hand Rule gives induced current direction.",
  'id': 'electromagnetism',
  ...
  'triple_only': None,
  'variables': []},
 {'common_mistake': "Fleming's LEFT-hand rule is for MOTORS (force on current in a field). Fleming's RIGHT-hand rule "
                    'is for GENERATORS (induced current from motion in a field). Students often use the wrong hand. '
                    'Remember: Left = motor effect (current → force). Right = generator effect (motion → current).',
  'equations': ['F = B × I × l'],
  'fifas': [{'label': 'Motor Effect Force',
             'question': 'A wire of length 0.05 m carries a current of 4 A in a magnetic field of flux density 2 T '
                         '(perpendicular to the wire). Calculate the force on the wire.',
             'steps': [('F', 'F = B × I × l'),
                       ('I', 'B = 2 T, I = 4 A, l = 0.05 m'),
                       ('F', 'F = 2 × 4 × 0.05 = 2 × 0.2'),
                       ('A', 'F = 0.4 N')]}],
  'higher': None,
  'id': 'flemings-left-hand-rule',
  'key_note': "Motor effect: force on current-carrying conductor in magnetic field. F = BIl. Fleming's LEFT-hand rule: "
              'First finger = Field, seCond = Current, thuMb = Motion/Force. Force maximised when conductor ⊥ field. '
              'Reverse current or field → reverse force. Applications: loudspeakers, motors, meters.',
  'matching': {'instruction': "Match each finger to what it represents in Fleming's Left-Hand Rule.",
               'pairs': [('First finger (index)', 'Direction of MAGNETIC FIELD — points from N to S'),
                         ('Second finger (middle)', 'Direction of conventional CURRENT — points from + to −'),
                         ('Thumb', 'Direction of FORCE (motion) on the conductor'),
                         ('F = BIl', 'Force increases with stronger field, larger current, longer conductor')],
               'title': "Fleming's Left-Hand Rule"},
  'quiz': [{'opts': [('Out of the page (towards the observer) — field down, current right, force out', True),
                     ('Into the page — field down, current right, force in', False),
                     ('Upward — force is opposite to the field direction', False),
                     ('To the left — force is opposite to current direction', False)],
            'q': "A horizontal wire carries current to the right in a downward magnetic field. Using Fleming's "
                 'Left-Hand Rule, in which direction is the force on the wire?',
            'wrong_explanations': {1: 'Apply the rule carefully: first finger DOWN (field), second finger RIGHT '
                                      '(current), thumb points OUT OF PAGE — not into.',
                                   2: 'Force is perpendicular to BOTH the field and current — not opposite to either '
                                      'individually.',
                                   3: 'Force is perpendicular to current, not opposite to it — F = BIl gives a force '
                                      'at right angles to both.'}},
           {'opts': [('Reverse the current direction OR reverse the magnetic field direction — either change reverses '
                      'the force',
                      True),
                     ('Increase the current magnitude — larger current reverses the force direction', False),
                     ('Move the conductor parallel to the field — this reverses the force', False),
                     ('Reduce the magnetic flux density to zero then increase it again', False)],
            'q': 'How can the direction of force on a current-carrying conductor in a magnetic field be reversed?',
            'wrong_explanations': {1: 'Changing the MAGNITUDE of current changes the FORCE SIZE — not its direction.',
                                   2: 'A conductor parallel to the field experiences ZERO force — not reversed force.',
                                   3: 'Reducing B to zero means no force — increasing it again gives the same '
                                      'direction as before.'}}],
  'rp': None,
  'spec': '6.7.2.2',
  'summary': "Apply Fleming's Left-Hand Rule to predict force on a current-carrying conductor in a magnetic field.",
  'theory': [{'content': 'When a CURRENT-CARRYING CONDUCTOR is placed in a MAGNETIC FIELD, it experiences a FORCE.\n'
                         'This is called the MOTOR EFFECT.\n'
                         '\n'
                         'The force occurs because the magnetic field of the current interacts with the external '
                         'magnetic field — the two fields combine to create a stronger field on one side and weaker on '
                         'the other, pushing the conductor towards the weaker side.\n'
                         '\n'
             ...
             {'content': "FLEMING'S LEFT-HAND RULE predicts the direction of force on a current-carrying conductor in "
                         'a magnetic field.\n'
                         '\n'
                         ...
                         '\n'
                         'RIGHT-HAND RULE is used for GENERATORS (opposite — motion given, find induced current '
                         'direction).',
             ...
             {'content': 'The motor effect is the basis of ELECTRIC MOTORS and other electromagnetic devices.\n'
                         ...
                         'Charged particles moving through magnetic fields experience forces (motor effect for moving '
                         'charges).\n'
                         'This curves the path of particles in cyclotrons and synchrotrons.',
              'heading': 'Applications of the Motor Effect'}],
  'title': "Fleming's Left-Hand Rule and the Motor Effect",
  'triple_only': None,
  'variables': [('F', 'Force on conductor', 'newtons', 'N'),
                ('B', 'Magnetic flux density', 'tesla', 'T'),
                ('I', 'Current', 'amperes', 'A'),
                ('l', 'Length of conductor in field', 'metres', 'm')]},
 {'common_mistake': 'The SPLIT-RING COMMUTATOR swaps the current direction every half turn — this is what makes a DC '
                    'motor spin continuously rather than oscillating. Without the commutator, the coil would rock back '
                    'and forth. The commutator is unique to DC motors — AC motors use a different mechanism.',
  'equations': [],
  'fifas': [],
  'higher': None,
  'id': 'electric-motors',
  'key_note': 'DC motor: coil in magnetic field → motor effect forces → torque → rotation. Split-ring commutator: '
              'swaps current every half-turn → continuous rotation. Increase speed: more current, stronger field, more '
              'turns, iron core. Applications: EVs, appliances, industrial machines. Regenerative braking: motor acts '
              'as generator.',
  'matching': {'instruction': 'Match each motor component to its function.',
               'pairs': [('Coil of wire', 'Carries current in the magnetic field — experiences motor effect force'),
                         ('Permanent magnet', 'Provides the magnetic field for the motor effect'),
  ...
  'quiz': [{'opts': [('It reverses the current in the coil every half turn — ensuring the forces always act to rotate '
                      'the coil in the same direction',
                      True),
                     ('It increases the magnetic field strength — making the motor more powerful', False),
                     ('It converts AC supply to DC for the motor coil', False),
                     ('It connects the motor to the power supply — without it no current would flow', False)],
            'q': 'Why does a DC motor need a split-ring commutator?',
            'wrong_explanations': {1: "The commutator doesn't affect field strength — it only switches current "
                                      'direction.',
                                   2: "A commutator converts DC to pulsed DC in the coil — it's not an AC-to-DC "
                                      "converter (that's a rectifier).",
                                   3: 'The brushes connect to the supply — the commutator specifically reverses '
                                      'current direction at the right moment.'}},
           {'opts': [('Kinetic energy → electrical energy — the motor runs in reverse as a generator, charging the '
                      'battery',
                      True),
                     ('Electrical energy → kinetic energy — the motor accelerates the car to a stop', False),
                     ('Chemical energy → thermal energy — brakes convert stored energy to heat', False),
                     ('Kinetic energy → thermal energy — friction brakes absorb kinetic energy as heat', False)],
            'q': 'An electric vehicle uses regenerative braking. What energy transfer occurs?',
            'wrong_explanations': {1: 'Accelerating the car to a stop makes no sense — regenerative braking '
                                      'decelerates by extracting energy from the motion.',
                                   2: 'Conventional friction brakes do convert KE to thermal — but regenerative '
                                      'braking specifically avoids this by converting to electrical energy instead.',
                                   3: 'Both conventional braking (KE → thermal) and regenerative braking (KE → '
                                      'electrical) happen simultaneously in many EVs — but regenerative braking '
                                      'specifically refers to the electrical recovery.'}}],
  'rp': None,
  'spec': '6.7.2.3',
  'summary': 'Explain how the motor effect causes a coil to rotate in an electric motor.',
  'theory': [{'content': 'A DC ELECTRIC MOTOR converts electrical energy into kinetic energy (rotation).\n'
                         '\n'
                         'KEY COMPONENTS:\n'
                         ...
                         'BRUSHES — stationary carbon contacts that touch the commutator and connect to the power '
                         'supply.\n'
                         '\n'
                         'HOW IT ROTATES:\n'
                         ...
                         '3. The forces on opposite sides of the coil are in OPPOSITE DIRECTIONS → creates a turning '
                         'force (TORQUE).\n'
                         '4. The coil rotates.\n'
                         '\n'
                         'WHY IT KEEPS ROTATING — THE COMMUTATOR:\n'
                         'Without the commutator: after rotating 90°, the coil would reach vertical — the forces '
                         'become parallel to the coil plane → no more torque → coil would oscillate, not spin '
                         'continuously.\n'
                         'The SPLIT-RING COMMUTATOR swaps the current direction in the coil every half turn → forces '
                         'always push the coil in the same rotation direction → continuous rotation.',
             ...
             {'content': 'Electric motors are found in almost every electrical device that involves rotation:\n'
                         ...
                         'Can act as GENERATORS during braking (regenerative braking — recovers KE back to electrical '
                         'store).\n'
                         '\n'
  ...
  'triple_only': None,
  'variables': []},
 {'common_mistake': 'The cone of a loudspeaker is driven by the MOTOR EFFECT — the force on a current-carrying '
                    'conductor in a magnetic field. The alternating current changes direction, so the force changes '
                    'direction, making the cone move in and out. The frequency of sound produced equals the frequency '
                    'of the AC signal.',
  'equations': [],
  'fifas': [],
  'higher': 'HT only — describe how the motor effect drives a loudspeaker. Explain why alternating current is needed. '
            'Relate the frequency and amplitude of the AC signal to the properties of the sound produced.',
  'id': 'loudspeakers-headphones',
  'key_note': 'Loudspeaker: AC through voice coil in permanent magnet field → motor effect → cone vibrates → sound. AC '
              'frequency = sound frequency. Amplitude of current → loudness. Headphones: same principle, miniaturised. '
              'Energy: electrical → kinetic → sound (with some thermal losses).',
  'matching': {'instruction': 'Match each component to its role in a loudspeaker.',
               'pairs': [('Permanent magnet',
                          'Provides constant magnetic field in which the voice coil experiences a force'),
                         ('Voice coil', 'Carries the AC signal — force from motor effect drives it back and forth'),
                         ('Cone (diaphragm)', 'Attached to coil — vibrates to push and pull air, creating sound waves'),
                         ('Frequency of AC', 'Determines the frequency (pitch) of the sound produced')],
               'title': 'Loudspeaker Operation'},
  'quiz': [{'opts': [('DC produces a constant force in one direction — the cone would deflect once and stop. AC '
                      'reverses direction, reversing the force, making the cone vibrate and produce sound.',
                      True),
                     ('AC provides more power than DC — louder sound is produced', False),
                     ('DC would destroy the voice coil due to overheating — AC protects it', False),
                     ('AC matches the natural frequency of the cone — DC would cause resonance problems', False)],
            'q': 'Why must the electrical signal driving a loudspeaker be alternating current (AC)?',
            'wrong_explanations': {1: 'AC and DC can provide the same power — the reason for AC is about the DIRECTION '
                                      'of force, not power level.',
                                   2: 'DC heating is a concern, but the fundamental reason is that DC produces '
                                      'unidirectional force — AC reversal creates oscillation.',
                                   3: 'Resonance happens at specific frequencies — the loudspeaker is designed to '
                                      'respond to all frequencies, not just one.'}},
           {'opts': [('Low frequency (low pitch) and large amplitude (loud)', True),
                     ('High frequency (low pitch) and large amplitude (loud)', False),
                     ('Low frequency (low pitch) and small amplitude (loud)', False),
                     ('High frequency (loud) and small amplitude (low pitch)', False)],
            'q': 'A loudspeaker produces a loud, low-pitched sound. What can you say about the AC signal driving it?',
            'wrong_explanations': {1: 'Low pitch = LOW frequency AC — high frequency would produce a high-pitched '
                                      'sound.',
                                   2: 'Low pitch = low frequency AC; loud = large amplitude — small amplitude produces '
                                      'quiet sound.',
                                   3: 'Loudness comes from AMPLITUDE of AC (larger current → larger force → bigger '
                                      'vibrations); frequency determines pitch.'}}],
  'rp': None,
  'spec': '6.7.2.4 (HT only, physics only)',
  'summary': 'Describe how loudspeakers and headphones use the motor effect to produce sound.',
  'theory': [{'content': 'A LOUDSPEAKER converts electrical energy (alternating current) into sound energy using the '
                         'MOTOR EFFECT.\n'
                         '\n'
                         'COMPONENTS:\n'
                         ...
                         '5. Vibrating cone pushes and pulls air → creates compressions and rarefactions → SOUND '
                         'WAVES.\n'
                         '\n'
                         'FREQUENCY OF SOUND = frequency of the alternating current.\n'
                         'AMPLITUDE (loudness) ∝ amplitude of current (larger current → larger force → bigger '
                         'vibrations → louder sound).',
             ...
             {'content': 'ENERGY TRANSFER IN A LOUDSPEAKER:\n'
                         'Electrical energy (from amplifier) → kinetic energy (voice coil moving) → sound energy '
                         '(sound waves).\n'
  ...
  'title': 'Loudspeakers and Headphones',
  'triple_only': 'Loudspeakers and headphones (HT only, physics only) — not in Combined Science.',
  'variables': []},
 {'common_mistake': 'A potential difference is induced when the magnetic flux CHANGES — not just when a conductor is '
                    'in a magnetic field. A conductor stationary in a magnetic field has no induced pd. The faster the '
                    "change, the larger the induced pd (Faraday's Law). Lenz's Law: the induced current OPPOSES the "
                    'change — not just in any direction.',
  'equations': [],
  'fifas': [],
  'higher': 'HT only — describe the generator effect and factors affecting induced pd. Explain why AC is produced by a '
            "simple generator and how a split-ring commutator gives DC output. Apply Fleming's right-hand rule to find "
            'induced current direction.',
  'id': 'induced-potential',
  'key_note': 'Generator effect: changing magnetic flux induces pd. Faraday: pd ∝ rate of flux change. Lenz: induced '
              'current opposes change. Increase pd: faster movement, stronger magnet, more coil turns, larger area. AC '
              'generator: rotating coil → sinusoidal output. DC: split-ring commutator reverses connections each '
              'half-turn.',
  'matching': {'instruction': 'Match each change to its effect on the induced pd.',
               'pairs': [('Magnet moved faster', 'Increased rate of flux change → larger induced pd'),
                         ('Fewer coil turns', 'Less conductor cutting field per rotation → smaller induced pd'),
                         ('Larger magnet', 'Greater magnetic flux → greater change → larger induced pd'),
                         ('Coil stationary in field', 'No change in flux → no induced pd')],
               'title': 'Generator Effect'},
  'quiz': [{'opts': [('The changing magnetic flux as the magnet moves induces the current. Push faster, use stronger '
                      'magnet, or use more coil turns to increase it.',
                      True),
                     ...
                     ('Friction between the magnet and coil generates the current. Push harder for more current.',
                      False),
                     ('The proximity to the coil induces current. Bring the magnet closer without moving it for '
                      'maximum effect.',
                      False)],
            'q': 'A bar magnet is pushed into a coil of wire. What induces a current, and how can the induced current '
                 'be increased?',
            'wrong_explanations': {1: 'A static magnetic field — however strong — induces NO current. The field must '
                                      'CHANGE to induce a current.',
                                   2: 'Friction is irrelevant — electromagnetic induction is caused by changing flux, '
                                      'not mechanical friction.',
                                   3: 'A stationary magnet close to a coil induces NO current — the flux must be '
                                      'CHANGING (the magnet must be moving).'}},
           {'opts': [('As the coil rotates, the rate at which it cuts field lines varies sinusoidally — the emf and '
                      'current reverse direction every half-turn',
                      True),
                     ('AC generators use alternating magnets that switch polarity regularly — this produces AC', False),
                     ('The slip rings swap connections every half-turn — reversing the current direction', False),
                     ('Generators always produce AC — there is no physical way to make DC from rotation', False)],
            'q': 'Why does a simple AC generator produce alternating current rather than direct current?',
            'wrong_explanations': {1: "Generator magnets are permanent — they don't switch polarity. The AC arises "
                                      "from the coil's rotation geometry.",
                                   2: "Slip rings maintain continuous connection without reversal — it's the "
                                      'SPLIT-RING COMMUTATOR (not slip rings) that produces DC by swapping connections '
                                      'each half-turn.',
                                   3: 'DC CAN be produced from rotation — using a split-ring commutator instead of '
                                      'slip rings.'}}],
  'rp': None,
  'spec': '6.7.3.1 (HT only, physics only)',
  'summary': 'Describe how a potential difference is induced when magnetic flux through a conductor changes.',
  'theory': [{'content': 'The GENERATOR EFFECT (electromagnetic induction): a POTENTIAL DIFFERENCE (voltage) is '
                         'induced in a conductor when there is a CHANGE IN MAGNETIC FLUX through that conductor.\n'
                         '\n'
                         "Faraday's Law:\n"
             ...
             {'content': 'To INCREASE the induced pd from a generator:\n'
                         ...
                         'Every half-turn, the connections swap → current in external circuit always flows in same '
                         'direction → DC (pulsing).\n'
  ...
  'title': 'Induced Potential and the Generator Effect',
  'triple_only': 'Induced potential and the generator effect (HT only, physics only) — not in Combined Science.',
  'variables': []},
 {'common_mistake': "ALTERNATORS use SLIP RINGS (give AC). DYNAMOS use SPLIT-RING COMMUTATORS (give DC). It's the type "
                    'of connection, not the mechanical principle, that determines AC vs DC output. In modern '
                    'generators, the magnet often rotates inside a fixed coil — but electromagnetic induction still '
                    'occurs.',
  'equations': [],
  'fifas': [],
  'higher': 'HT only — describe the construction and output of alternators and dynamos. Explain the difference between '
            'slip rings (AC) and split-ring commutators (DC). Describe back-emf in electric motors.',
  'id': 'uses-generator-effect',
  'key_note': 'Alternator: slip rings → AC output (50 Hz in UK). Dynamo: split-ring commutator → pulsing DC. Uses: '
              'alternators in power stations (steam turbines), car engines (charges battery), wind turbines. Dynamos: '
              'bicycle lights. Back-emf in motors: opposes supply, limits current at full speed.',
  'matching': {'instruction': 'Match each generator type to its construction and output.',
               'pairs': [('Alternator', 'Slip rings and brushes — output is sinusoidal AC'),
                         ('Dynamo', 'Split-ring commutator — output is pulsing DC'),
                         ('Modern wind turbine generator',
                          'Rotating permanent magnet inside fixed coil — no slip rings needed'),
                         ('Back-emf', 'Opposing voltage generated by rotating motor — limits current at full speed')],
               'title': 'Alternators and Dynamos'},
  'quiz': [{'opts': [("The alternator uses slip rings — the connections don't reverse, giving AC. The dynamo uses a "
                      'split-ring commutator which swaps connections each half-turn, giving pulsing DC.',
                      True),
                     ('Alternators use stronger magnets — this produces AC. Dynamos use weaker magnets producing DC.',
                      False),
                     ('Alternators rotate faster — high-speed rotation produces AC. Slow rotation gives DC.', False),
                     ('Alternators have more coil turns — more turns produces AC. Fewer turns gives DC.', False)],
            'q': 'Why does an alternator produce AC while a dynamo produces DC?',
            'wrong_explanations': {1: "Magnet strength affects the magnitude of the output, not whether it's AC or DC.",
                                   2: 'Rotation speed affects frequency and magnitude — not whether the output is AC '
                                      'or DC.',
                                   3: 'Number of turns affects the magnitude of the emf — not AC vs DC.'}},
           {'opts': [('A voltage generated by the rotating motor coil that opposes the supply — it limits the current '
                      'drawn at full speed, making the motor efficient',
                      True),
                     ('A voltage that helps the motor start — providing extra torque at startup', False),
                     ('A signal that tells the motor to reverse direction when needed', False),
                     ("The voltage dropped across the motor's internal resistance — represents wasted energy", False)],
            'q': "What is 'back-emf' in an electric motor, and why is it important?",
            'wrong_explanations': {1: 'Back-emf OPPOSES the supply — at startup when back-emf = 0, current is HIGH '
                                      "(potentially damaging). It doesn't help startup.",
                                   2: "Back-emf has no signalling function — it's a physical consequence of the "
                                      'generator effect in a running motor.',
                                   3: "Voltage drop across resistance is IR (Ohm's law) — back-emf is a separate "
                                      'effect from resistance, caused by the generator effect.'}}],
  'rp': None,
  'spec': '6.7.3.2 (HT only, physics only)',
  'summary': 'Describe alternators, dynamos and their role as generators of electrical power.',
  'theory': [{'content': 'An ALTERNATOR is an AC generator — produces alternating current.\n'
                         '\n'
                         'CONSTRUCTION:\n'
                         'Coil of wire rotating in a magnetic field.\n'
             ...
             {'content': 'A DYNAMO produces direct current (DC) using a split-ring commutator.\n'
                         ...
                         'Every half-rotation, the connections swap → current in external circuit always flows in the '
                         'same direction.\n'
                         '\n'
                         'OUTPUT:\n'
             ...
             {'content': 'ROTATING MAGNET GENERATORS (modern design):\n'
                         ...
                         'At full speed: back-emf nearly equals supply voltage → current is low, motor runs '
                         'efficiently.',
              'heading': 'Electromagnetic Induction in Practice'}],
  'title': 'Uses of the Generator Effect',
  'triple_only': 'Uses of the generator effect — alternators and dynamos (HT only, physics only) — not in Combined '
                 'Science.',
  'variables': []},
 {'common_mistake': 'A microphone uses the GENERATOR EFFECT (motion → current), not the motor effect. A loudspeaker '
                    'uses the MOTOR EFFECT (current → motion). They are exact reverses of each other. The frequency of '
                    'the induced AC from a microphone equals the frequency of the sound waves hitting the diaphragm.',
  'equations': [],
  'fifas': [],
  'higher': 'HT only — describe how a dynamic microphone uses the generator effect to convert sound to electrical '
            'signals. Compare with the motor effect in loudspeakers. Explain why the induced current has the same '
            'frequency as the sound.',
  'id': 'microphones',
  'key_note': 'Dynamic microphone: sound → diaphragm vibrates → coil in magnetic field → generator effect → AC signal '
              'at same frequency as sound. Reverse of loudspeaker. Condenser: capacitance change method. Output: small '
              'AC (millivolts) → needs amplification. Both microphone and loudspeaker are electromagnetic transducers.',
  'matching': {'instruction': 'Match each device to the energy conversion and physical principle.',
               'pairs': [('Loudspeaker',
                         ...
                         ('Both', 'Use a coil of wire moving in a permanent magnetic field'),
                         ('Condenser microphone',
                          'Sound changes capacitance of diaphragm-backplate gap → voltage signal')],
               'title': 'Microphone vs Loudspeaker'},
  'quiz': [{'opts': [('Microphone: sound moves the coil → generator effect → AC output. Loudspeaker: AC input → motor '
                      'effect → coil moves cone → sound. They are exact reverses.',
                      True),
                     ('Microphone has a smaller coil than a loudspeaker — smaller coils detect sound, larger coils '
                      'produce it',
                      False),
            ...
            'wrong_explanations': {1: 'Size differs for practical reasons — but the principle difference is MOTOR '
                                      'EFFECT (loudspeaker) vs GENERATOR EFFECT (microphone).',
                                   2: 'Both microphones and loudspeakers deal with AC signals — microphone output IS '
                                      'AC at the sound frequency.',
                                   3: 'The microphone uses the GENERATOR EFFECT — sound moves the coil, inducing '
                                      'current — not the motor effect.'}},
           {'opts': [('440 Hz — the coil vibrates at 440 Hz (driven by the sound wave) so the induced current '
                      'alternates at 440 Hz',
                      True),
                     ('880 Hz — the frequency doubles due to electromagnetic induction', False),
                     ('220 Hz — the frequency halves as mechanical vibration converts to electrical', False),
                     ('50 Hz — AC output is always at mains frequency regardless of sound frequency', False)],
            'q': 'What frequency is the AC output from a microphone when someone sings a note at 440 Hz?',
            'wrong_explanations': {1: "Frequency doesn't double — the coil vibrates at exactly the same rate as the "
                                      'sound wave, so the induced current frequency matches.',
                                   2: 'Frequency halves — the coil vibrates at the same rate as the sound, inducing AC '
                                      'at the same frequency.',
                                   3: 'AC output frequency matches the input sound frequency — 50 Hz would mean all '
                                      'sounds come out at the same frequency regardless of pitch.'}}],
  'rp': None,
  'spec': '6.7.3.3 (HT only, physics only)',
  'summary': 'Describe how microphones use electromagnetic induction to convert sound into electrical signals.',
  'theory': [{'content': 'A MICROPHONE converts sound energy into electrical energy using ELECTROMAGNETIC INDUCTION — '
                         'the reverse of a loudspeaker.\n'
                         '\n'
  ...
  'title': 'Microphones',
  'triple_only': 'Microphones (HT only, physics only) — not in Combined Science.',
  'variables': []},
 {'common_mistake': 'Transformers only work with AC — not DC. DC produces constant flux → no change → no induced emf. '
                    'Step-up transformer increases VOLTAGE but DECREASES current (power is conserved). National Grid '
                    'uses high voltage to REDUCE current → reduces I²R power losses in transmission cables.',
  'equations': ['Vₛ/Vₚ = Nₛ/Nₚ  (turns ratio equation)',
                'Vₚ × Iₚ = Vₛ × Iₛ  (power conservation in ideal transformer)'],
  'fifas': [{'label': 'Transformer Voltage',
             'question': 'A transformer has 200 primary turns and 800 secondary turns. Input voltage = 230 V. Find the '
                         'output voltage.',
             'steps': [('F', 'Vs/Vp = Ns/Np'),
                       ('I', 'Vp = 230 V, Np = 200, Ns = 800'),
                       ('F', 'Vs = Vp × (Ns/Np) = 230 × (800/200) = 230 × 4'),
                       ('A', 'Vs = 920 V (step-up transformer)')]}],
  'higher': 'HT only — use the turns ratio equation to calculate transformer voltages and turns. Apply power '
            'conservation to find current in transformer circuits. Explain why the National Grid uses high voltage '
            'transmission and calculate power losses at different voltages.',
  'id': 'transformers',
  'key_note': 'Transformer: AC in primary → alternating flux in iron core → emf induced in secondary. Turns ratio: '
              'Vs/Vp = Ns/Np. Step-up: Ns > Np. Power conservation: Vp×Ip = Vs×Is. National Grid: step-up to ~400 kV '
              'for transmission (low current → less I²R loss), step-down for consumers. AC only — DC gives constant '
              'flux, no induction.',
  'matching': {'instruction': 'Match each transformer scenario to the correct calculation.',
               'pairs': [('Step-up transformer', 'Ns > Np → output voltage greater than input voltage'),
                         ('Step-down transformer', 'Ns < Np → output voltage less than input voltage'),
                         ('National Grid transmission', 'Step-up to ~400 kV → low current → low I²R losses in cables'),
                         ('Power conservation', 'Vp × Ip = Vs × Is — higher voltage means lower current')],
               'title': 'Transformer Equations'},
  'quiz': [{'opts': [('DC produces a constant magnetic flux — no change in flux means no induced emf in the secondary '
                      "coil (Faraday's law requires changing flux)",
                      True),
                     ('DC is too powerful for the iron core — it would overheat and be destroyed', False),
                     ('DC cannot flow through coils of wire — coils require AC to function', False),
                     ('DC has a frequency of zero — transformers are calibrated for 50 Hz only', False)],
            'q': "Why can't transformers work with direct current (DC)?",
            'wrong_explanations': {1: 'DC can flow through transformer coils and would create a magnetic field — but a '
                                      'CONSTANT field causes no induction.',
                                   2: "DC flows through coils perfectly well — it's the absence of CHANGE that "
                                      'prevents transformer action.',
                                   3: 'Technically DC frequency = 0 Hz, and transformers are designed for 50 Hz — but '
                                      'the fundamental reason is CONSTANT FLUX, not calibration.'}},
           {'opts': [('High voltage means low current for the same power — less power wasted as heat in cables since '
                      'P_loss = I²R',
                      True),
                     ('High voltage makes electricity travel faster through the cables', False),
                     ('High voltage prevents energy loss by radiation — lower voltage radiates more energy', False),
                     ('Transformers only work at high voltages — required for transformer compatibility', False)],
            'q': 'Why does the National Grid transmit electricity at very high voltages?',
            'wrong_explanations': {1: 'Electrical signals travel at nearly the speed of light regardless of voltage — '
                                      "voltage doesn't affect transmission speed.",
                                   2: 'While there is some electromagnetic radiation from power lines, this is not the '
                                      'reason for high voltage — P_loss = I²R is the key formula.',
                                   3: 'Transformers work at any voltage — the reason for high voltage is specifically '
                                      'to reduce current and therefore reduce I²R heating losses.'}}],
  'rp': None,
  'spec': '6.7.3.4 (HT only, physics only)',
  'summary': 'Describe how transformers work and use the transformer equation to solve problems.',
  'theory': [{'content': 'A TRANSFORMER changes the voltage of an alternating current supply.\n'
                         '\n'
                         'CONSTRUCTION:\n'
                         ...
                         '\n'
                         'CRITICAL: Transformers only work with AC — DC produces a CONSTANT magnetic flux, which does '
                         'not change and therefore induces no emf.',
             ...
             {'content': 'NATIONAL GRID uses transformers to transmit electricity efficiently.\n'
                         '\n'
                         'POWER STATION → STEP-UP TRANSFORMER → HIGH VOLTAGE TRANSMISSION → STEP-DOWN TRANSFORMER → '
                         'CONSUMERS\n'
                         '\n'
                         'Typically: 25 kV (power station) → 400 kV (transmission) → 33 kV (industrial) → 11 kV → 230 '
                         'V (homes).\n'
                         '\n'
  ...
  'title': 'Transformers',
  'triple_only': 'Transformers (HT only, physics only) — not in Combined Science.',
  'variables': [('Vₚ', 'Primary voltage', 'volts', 'V'),
                ('Vₛ', 'Secondary voltage', 'volts', 'V'),
...
"space": [{'common_mistake': 'Geostationary orbits are above the EQUATOR and have a period of exactly 24 hours — they appear '
  ...
  'equations': [],
  'fifas': [],
  'higher': 'Explain qualitatively how gravity provides centripetal force for circular orbits. Describe what happens '
            'to orbital radius if speed changes. Compare geostationary and LEO satellites. Explain why lower orbits '
            'have shorter periods and higher speeds.',
  ...
  'variables': []},
 {'common_mistake': 'In circular motion at constant speed, the object is ACCELERATING (velocity direction changes). '
                    "The centripetal force is always directed towards the CENTRE — it's provided by gravity for "
                    'orbital motion. To move to a HIGHER orbit, a satellite must increase speed — but the final speed '
                    'in the higher orbit is actually lower (paradoxically).',
  'equations': [],
  'fifas': [],
  'higher': 'HT only — explain qualitatively how gravity provides centripetal force for circular orbits. Explain why '
            'orbital speed must change if orbital radius changes for a stable orbit. Describe what happens when a '
            "satellite's speed changes.",
  'id': 'gravity-stable-orbits',
  'key_note': 'Gravity = centripetal force for orbits. Lower orbit: stronger gravity, faster speed, shorter period. '
              'Geostationary: 36,000 km, 24 hrs, appears stationary. If speed↑ at same radius → spiral out to larger '
              'orbit. If speed↓ → fall to smaller orbit. LEO satellites decay due to atmospheric drag → re-enter.',
  'matching': {'instruction': 'Match each orbital scenario to the correct outcome.',
               'pairs': [('Satellite at correct orbital speed',
                          'Stable circular orbit — gravity exactly provides centripetal force'),
                         ('Satellite speed increases at same radius',
                          'Spirals outward to higher orbit — centripetal force required exceeds gravity'),
                         ('Atmospheric drag slows LEO satellite',
                          'Orbit decays — satellite spirals inward and re-enters atmosphere'),
                         ('Geostationary orbit',
                          '~36,000 km altitude, 24-hour period — appears stationary above equator')],
               'title': 'Orbital Mechanics'},
  'quiz': [{'opts': [('The orbit decays — it spirals inward to lower and lower orbits until it re-enters the '
                      'atmosphere',
                      True),
                     ('The satellite settles into a higher orbit — slower speed is stable at greater altitude', False),
                     ('The satellite stops orbiting and falls straight down', False),
                     ('The satellite accelerates due to stronger gravity at lower altitude', False)],
            'q': 'A satellite in low Earth orbit gradually slows due to atmospheric drag. What eventually happens?',
            'wrong_explanations': {1: 'When a satellite slows, gravity pulls it to a lower orbit (not higher) — at '
                                      'lower altitude, the orbit actually requires higher speed, but without engine '
                                      'thrust the satellite cannot sustain even that reduced orbit.',
                                   2: "Objects don't fall 'straight down' in orbit — they spiral gradually inward and "
                                      'heat up due to atmospheric friction.',
                                   3: 'The satellite does accelerate slightly at lower altitude (gravity is stronger) '
                                      'but the atmospheric drag eventually causes re-entry.'}},
           {'opts': [('It orbits at exactly the same rate as Earth rotates — 24-hour orbital period at ~36,000 km '
                      'altitude',
                      True),
                     ('It is so far away that it barely appears to move, even though it is actually moving fast',
                      False),
                     ("Geostationary satellites don't orbit — they hover by firing engines continuously", False),
                     ('At 36,000 km, gravity is too weak to pull the satellite forward — so it stays put', False)],
            'q': "Why does a geostationary satellite appear stationary from the Earth's surface?",
            'wrong_explanations': {1: 'Extremely distant objects still appear to move in the sky (e.g. other planets, '
                                      "stars shift). Geostationary is specifically about matching Earth's rotation "
                                      'rate.',
                                   2: 'Geostationary satellites orbit continuously — firing engines for a 24-hour '
                                      'orbit would use enormous fuel. They maintain orbit through balanced gravity and '
                                      'orbital speed.',
                                   3: "Gravity at 36,000 km is weaker than at Earth's surface but not zero — it's "
                                      'still the centripetal force for the orbit.'}}],
  'rp': None,
  'spec': '6.8.1 (HT only, physics only)',
  'summary': 'Explain how gravity provides centripetal force for orbits and how orbital speed relates to radius.',
  'theory': [{'content': 'For a circular orbit, gravity provides the CENTRIPETAL FORCE directing the orbiting body '
                         'towards the centre.\n'
                         '\n'
                         'GRAVITATIONAL FORCE:\n'
                         'All masses attract each other.\n'
                         'Gravitational force decreases with distance — further away → weaker gravity.\n'
                         'F = Gm₁m₂/r² (for context — formula not required at GCSE)\n'
                         '\n'
                         'For a STABLE CIRCULAR ORBIT:\n'
                         'Gravitational force = centripetal force required for that speed and radius.\n'
                         'If speed increases: more centripetal force needed → object spirals outward to larger orbit.\n'
                         'If speed decreases: less centripetal force needed → object falls to smaller orbit.\n'
                         '\n'
                         'ORBITAL SPEED AND RADIUS RELATIONSHIP:\n'
                         'Lower orbit (smaller r) → gravity stronger → higher orbital speed needed.\n'
                         'Higher orbit (larger r) → gravity weaker → lower orbital speed needed.\n'
                         'LEO (~400 km): ~7700 m/s orbital speed, ~90 min period.\n'
                         'Geostationary (~36,000 km): ~3000 m/s orbital speed, 24-hour period.',
              'heading': 'Gravity as Centripetal Force'},
             {'content': 'For a STABLE ORBIT at a given radius, there is only ONE correct speed.\n'
                         '\n'
                         ...
                         'A satellite slows due to atmospheric drag → orbit decays → re-enters.\n'
                         'Satellite needs to fire engines periodically to maintain orbit (compensate for drag).\n'
                         '\n'
                         'TRANSFER ORBITS:\n'
                         'To move from low orbit to high orbit: fire engines to INCREASE speed → transition to higher '
                         'orbit.\n'
                         'To move from high orbit to low orbit: fire engines to DECREASE speed → fall to lower orbit.\n'
                         'Counter-intuitive: firing engines forward → end up in higher, SLOWER orbit.\n'
                         '\n'
                         'GEOSTATIONARY ORBIT:\n'
              ...
              'heading': 'Changing Speed in Circular Orbits'},
             {'content': "ESCAPE VELOCITY: the minimum speed needed to leave a body's gravitational field.\n"
                         'For Earth: ~11.2 km/s.\n'
                         '\n'
                         'BLACK HOLES:\n'
                         'Extremely dense objects where escape velocity exceeds the speed of light.\n'
                         'Light cannot escape → perfectly black.\n'
                         ...
                         'Massive objects curve space-time → affects path of light.\n'
                         'Gravitational lensing: light from distant galaxies bent around massive objects → multiple '
                         'images.\n'
                         '\n'
                         'TIDES:\n'
                         'Differences in gravitational pull of the Moon on near and far sides of Earth → tidal '
                         'bulges.\n'
              ...
              'heading': 'Escape Velocity and Black Holes'}],
  'title': 'Gravity, Stable Orbits and Orbital Speed',
  'triple_only': 'Gravity and stable orbits — detailed analysis (HT only, physics only).',
  'variables': []},
 {'common_mistake': "PLANETARY NEBULA has nothing to do with planets — it's a cloud of gas ejected by a dying medium "
  ...
  'equations': [],
  'fifas': [],
  'higher': 'Explain the mechanism of each stage in stellar evolution in terms of force balance (gravity vs radiation '
            'pressure). Describe the specific conditions that determine whether a stellar remnant becomes a white '
            'dwarf, neutron star or black hole. Explain the nucleosynthesis of heavy elements in supernovae.',
 ...
 {'common_mistake': 'Red-shift does NOT mean galaxies are moving THROUGH space away from us — it means SPACE ITSELF is '
  ...
  'fifas': [],
  'higher': "Apply Hubble's Law: v = H₀d. Calculate recession speed from red-shift data. Explain how CMBR is strong "
            'evidence for the Big Bang. Evaluate the significance of dark matter and dark energy for the Big Bang '
            'model and the future of the universe.',
 ...
 {'common_mistake': 'Dark matter and dark energy are different: dark matter is a form of MATTER (has mass, interacts '
  ...
  'rp': None,
  'spec': '6.8.4 (HT only, physics only)',
  ...
  'title': 'Dark Matter and Dark Energy',
  'triple_only': 'Dark matter and dark energy (HT only, physics only) — not in Combined Science.',
  'variables': []}],
