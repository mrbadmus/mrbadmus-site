...
window.KS4D = (function () {
  ...
  var SYM = {
    cell: function (x, y, it) { return leads(x, y, 18) + line(x - 9, y - 26, x - 9, y + 26) + line(x + 9, y - 13, x + 9, y + 13, 7, C.stroke, ' stroke-linecap="butt"') + (it.value ? lab(x, y + 52, it.value, 22, C.red) : ''); },
    battery: function (x, y, it) { var s = leads(x, y, 52) + line(x - 10, y, x + 10, y, 2, C.stroke, ' stroke-dasharray="4 5"'); [-26, 10].forEach(function (dx) { s += line(x + dx, y - 26, x + dx, y + 26) + line(x + dx + 16, y - 13, x + dx + 16, y + 13, 7, C.stroke, ' stroke-linecap="butt"'); }); return s + (it.value ? lab(x, y + 52, it.value, 22, C.red) : ''); },
    ...
    switch: function (x, y, it) { return leads(x, y, 60) + circ(x - 30, y, 6, C.cream, C.stroke, 2.5) + circ(x + 30, y, 6, C.cream, C.stroke, 2.5) + (it.closed ? line(x - 30, y, x + 30, y) : line(x - 30, y, x + 24, y - 26)) + (it.name ? lab(x, y - 40, it.name) : ''); },
