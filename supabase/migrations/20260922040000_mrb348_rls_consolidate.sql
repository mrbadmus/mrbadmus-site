...
--
-- GENERATED FROM: project ref urklkrwevjtlfbwnipjn at 2026-09-22 02:29 UTC
-- Drops 106 policies across 29 tables; creates 88.
--
...
begin
  ...
  WHERE ((cm.class_id = class_shoutouts.class_id) AND (cm.left_at IS NULL) AND (cm.deleted_at IS NULL)))))$mrb348$),
      ...
      ($mrb348$class_teachers$mrb348$, $mrb348$class_teachers_member_read$mrb348$, $mrb348$SELECT$mrb348$, $mrb348$((class_school_id(class_id) = ( SELECT auth_user_school_id() AS auth_user_school_id)) AND auth_user_is_member_of_class(class_id))$mrb348$, null),
   ...
   FROM class_members cm
  WHERE ((cm.student_id = profiles.id) AND (cm.left_at IS NULL) AND (cm.deleted_at IS NULL) AND auth_user_teaches_class(cm.class_id)))))$mrb348$, null),
      ($mrb348$quiz_question_attempts$mrb348$, $mrb348$qqa_self_all$mrb348$, $mrb348$ALL$mrb348$, $mrb348$(EXISTS ( SELECT 1
   FROM quiz_scores qs
  WHERE ((qs.id = quiz_question_attempts.quiz_score_id) AND (qs.user_id = ( SELECT auth_user_id() AS auth_user_id)))))$mrb348$, $mrb348$(EXISTS ( SELECT 1
   FROM quiz_scores qs
  WHERE ((qs.id = quiz_question_attempts.quiz_score_id) AND (qs.user_id = ( SELECT auth_user_id() AS auth_user_id)))))$mrb348$),
      ($mrb348$quiz_question_attempts$mrb348$, $mrb348$qqa_teacher_read$mrb348$, $mrb348$SELECT$mrb348$, $mrb348$(EXISTS ( SELECT 1
   FROM (quiz_scores qs
     JOIN class_members cm ON (((cm.student_id = qs.user_id) AND (cm.left_at IS NULL) AND (cm.deleted_at IS NULL))))
  WHERE ((qs.id = quiz_question_attempts.quiz_score_id) AND auth_user_teaches_class(cm.class_id))))$mrb348$, null),
      ($mrb348$quiz_scores$mrb348$, $mrb348$Users can view own scores$mrb348$, $mrb348$SELECT$mrb348$, $mrb348$(( SELECT auth.uid() AS uid) = user_id)$mrb348$, null),
      ($mrb348$quiz_scores$mrb348$, $mrb348$quiz_scores_teacher_read$mrb348$, $mrb348$SELECT$mrb348$, $mrb348$(EXISTS ( SELECT 1
   FROM class_members cm
  WHERE ((cm.student_id = quiz_scores.user_id) AND (cm.left_at IS NULL) AND (cm.deleted_at IS NULL) AND auth_user_teaches_class(cm.class_id))))$mrb348$, null),
      ...
      ($mrb348$weekly_challenges$mrb348$, $mrb348$Authenticated users can view active challenges$mrb348$, $mrb348$SELECT$mrb348$, $mrb348$((( SELECT auth.role() AS role) = 'authenticated'::text) AND (active = true))$mrb348$, null),
      ($mrb348$weekly_challenges$mrb348$, $mrb348$Service role manages challenges$mrb348$, $mrb348$ALL$mrb348$, $mrb348$(( SELECT auth.role() AS role) = 'service_role'::text)$mrb348$, null),
      ($mrb348$weekly_scores$mrb348$, $mrb348$Authenticated can view weekly leaderboard$mrb348$, $mrb348$SELECT$mrb348$, $mrb348$(( SELECT auth.role() AS role) = 'authenticated'::text)$mrb348$, null),
      ($mrb348$weekly_scores$mrb348$, $mrb348$Users can view own scores$mrb348$, $mrb348$SELECT$mrb348$, $mrb348$(( SELECT auth.uid() AS uid) = user_id)$mrb348$, null)
  ...
  if n <> 106 then
    raise exception 'MRB-348 aborted: guard matched % policies, expected %', n, 106;
  end if;
...
drop policy "class_teachers_member_read" on public.class_teachers;
...
-- SELECT: class_teachers_admin_read, class_teachers_admin_write, class_teachers_hod_read, class_teachers_hod_write, class_teachers_member_read, class_teachers_operator_read, class_teachers_self_read
--   branch order (cost: policy)
...
create policy "class_teachers_select_merged" on public.class_teachers
  ...
  using (
    ...
    OR (((class_school_id(class_id) = ( SELECT auth_user_school_id() AS auth_user_school_id)) AND auth_user_is_member_of_class(class_id)))
  )
;
...
create policy "profiles_select_merged" on public.profiles
  ...
  using (
   ...
   FROM class_members cm
  WHERE ((cm.student_id = profiles.id) AND (cm.left_at IS NULL) AND (cm.deleted_at IS NULL) AND auth_user_teaches_class(cm.class_id))))))
  )
;
...
--     - qqa_self_all
--     - qqa_teacher_read
drop policy "qqa_self_all" on public.quiz_question_attempts;
drop policy "qqa_teacher_read" on public.quiz_question_attempts;

-- SELECT: qqa_self_all, qqa_teacher_read
--   branch order (cost: policy)
--     5: qqa_self_all
--     5: qqa_teacher_read
create policy "quiz_question_attempts_select_merged" on public.quiz_question_attempts
  as permissive for select to public
  using (
    ((EXISTS ( SELECT 1
   FROM quiz_scores qs
  WHERE ((qs.id = quiz_question_attempts.quiz_score_id) AND (qs.user_id = ( SELECT auth_user_id() AS auth_user_id))))))
    OR ((EXISTS ( SELECT 1
   FROM (quiz_scores qs
     JOIN class_members cm ON (((cm.student_id = qs.user_id) AND (cm.left_at IS NULL) AND (cm.deleted_at IS NULL))))
  WHERE ((qs.id = quiz_question_attempts.quiz_score_id) AND auth_user_teaches_class(cm.class_id)))))
  )
;
...
--   branch order (cost: policy)
--     5: qqa_self_all
create policy "quiz_question_attempts_insert_merged" on public.quiz_question_attempts
  as permissive for insert to public
  with check (
    ((EXISTS ( SELECT 1
   FROM quiz_scores qs
...
--   branch order (cost: policy)
--     5: qqa_self_all
create policy "quiz_question_attempts_update_merged" on public.quiz_question_attempts
  as permissive for update to public
  using (
    ((EXISTS ( SELECT 1
   FROM quiz_scores qs
...
--   branch order (cost: policy)
--     5: qqa_self_all
create policy "quiz_question_attempts_delete_merged" on public.quiz_question_attempts
  as permissive for delete to public
  using (
    ((EXISTS ( SELECT 1
   FROM quiz_scores qs
...
--     - quiz_scores_teacher_read
drop policy "Users can view own scores" on public.quiz_scores;
drop policy "quiz_scores_teacher_read" on public.quiz_scores;

-- SELECT: Users can view own scores, quiz_scores_teacher_read
--   branch order (cost: policy)
--     1: Users can view own scores
--     5: quiz_scores_teacher_read
create policy "quiz_scores_select_merged" on public.quiz_scores
  as permissive for select to public
  using (
    ((( SELECT auth.uid() AS uid) = user_id))
    OR ((EXISTS ( SELECT 1
   FROM class_members cm
  WHERE ((cm.student_id = quiz_scores.user_id) AND (cm.left_at IS NULL) AND (cm.deleted_at IS NULL) AND auth_user_teaches_class(cm.class_id)))))
  )
;
...
drop policy "Authenticated users can view active challenges" on public.weekly_challenges;
drop policy "Service role manages challenges" on public.weekly_challenges;

-- SELECT: Authenticated users can view active challenges, Service role manages challenges
--   branch order (cost: policy)
--     2: Authenticated users can view active challenges
--     2: Service role manages challenges
create policy "weekly_challenges_select_merged" on public.weekly_challenges
  as permissive for select to public
  using (
    (((( SELECT auth.role() AS role) = 'authenticated'::text) AND (active = true)))
    OR ((( SELECT auth.role() AS role) = 'service_role'::text))
  )
;

-- INSERT: Service role manages challenges
--   branch order (cost: policy)
--     2: Service role manages challenges
create policy "weekly_challenges_insert_merged" on public.weekly_challenges
  as permissive for insert to public
  with check (
...
-- UPDATE: Service role manages challenges
--   branch order (cost: policy)
--     2: Service role manages challenges
create policy "weekly_challenges_update_merged" on public.weekly_challenges
  as permissive for update to public
  using (
    ((( SELECT auth.role() AS role) = 'service_role'::text))
  )
...
-- DELETE: Service role manages challenges
--   branch order (cost: policy)
--     2: Service role manages challenges
create policy "weekly_challenges_delete_merged" on public.weekly_challenges
  as permissive for delete to public
  using (
    ((( SELECT auth.role() AS role) = 'service_role'::text))
  )
...
-- ---- weekly_scores -----------------------------------------------------
--   2 policies -> 1
--     - Authenticated can view weekly leaderboard
--     - Users can view own scores
drop policy "Authenticated can view weekly leaderboard" on public.weekly_scores;
drop policy "Users can view own scores" on public.weekly_scores;

-- SELECT: Authenticated can view weekly leaderboard, Users can view own scores
--   branch order (cost: policy)
--     1: Users can view own scores
--     2: Authenticated can view weekly leaderboard
create policy "weekly_scores_select_merged" on public.weekly_scores
  as permissive for select to public
  using (
    ((( SELECT auth.uid() AS uid) = user_id))
