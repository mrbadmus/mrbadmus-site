-- Rollback for 20260924180200_mrb351_rollup_kind.sql (MRB-351).
-- Re-creates teacher_class_rollup exactly as 20260922231500 left it.
-- Loses no data. Must run BEFORE the MRB-351 schema rollback only if the
-- schema rollback is also wanted (this body does not read `kind`).
