...
GATES = [
    ...
    dict(name="answer_lengths",
         ...
         why="MRB-297 — the tell POSITION cannot see. The row above watches "
             ...
             "scored 35% against 25% by chance, 56% in P11 (ties counted as "
             "a miss; the same measurement with ties to the first longest "
             "is the 37.7% below — one quantity, two tie rules). Every P1–P12 "
             ...
             "baselines for the bio/chem BANK and LADDER, which are worse "
             "and are already live; a baselined scope fails the moment it "
             "gets worse. It does NOT baseline the bio/chem HOOKS — it "
             "cannot measure them at all, because all 115 carry no `answer` "
             "index, and it now prints that gap at the head of every run "
             "instead of leaving it invisible ⚠️ TWO FIGURES, AND BOTH BELONG IN THE HEAD: the gate "
