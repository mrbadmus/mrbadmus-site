        ...
        {"type": "system-switch", "id": "switch-off-chains", "anchor": "s-switch",
         ...
         "parts": [
              ...
              ]},
             {
              ...
              "tab": "The ribcage",
              "name": "The ribcage",
              "does": "Twelve pairs of curved bones hinged at the spine, with muscles slung between them. Swinging them up and outwards is how you pull in more air than quiet breathing needs.",
              "prompt": "Switch it off. What is the first thing that goes wrong?",
              ...
              "options": [
                  "Breathing would carry on exactly as it does now, using the diaphragm",
                  "The heart would be exposed, but breathing would carry on",
                  "The chest wall is pulled inwards as you breathe in, so each breath moves far less air",
                  "You would simply breathe faster",
              ],
              "chain": [
                  {"level": "Organ",
                   "text": "The diaphragm still pulls down, but with nothing holding the chest wall out it is sucked inwards as you breathe in. The volume of the chest barely changes."},
                  {"level": "Organ",
                   "text": "Air only moves into the lungs because that volume increases. Far less arrives with every breath, and there is no way to pull in more."},
                  {"level": "Tissue",
                   "text": "Too little fresh air reaches the alveoli, so the blood leaving the lungs carries far less oxygen than it should."},
                  {"level": "Cell",
                   "text": "Within minutes every cell in the body — brain cells first — is short of the oxygen it needs for respiration."},
              ]},
             {
              "id": "femur",
              "tab": "Femur and hip",
        ...
        {"type": "job-sort", "id": "which-job", "anchor": "s-sort",
         ...
         "items": [
             ...
             {"id": "i5",
              ...
              "answer": "Support.",
              "why": "The bone has been loaded harder, so it has built more material exactly where the force goes. Support is the job it is tuning itself for."},
             {"id": "i6",
