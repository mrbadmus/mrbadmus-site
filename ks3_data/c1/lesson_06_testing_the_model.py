...
LESSON = {
    ...
    "requires":    ["diffusion"],
    "assumes":     [],
    # The forward link, and the one card in the unit that leaves it: C2 opens
    # on the model this lesson has just finished breaking.
    "references":  [{"unit": "C2", "lesson": "the-atom-daltons-model"}],
