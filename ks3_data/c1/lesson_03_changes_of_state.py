...
holding all of it at once will notice:
  ...
  2. **Eight minutes or six?** The big question says the climb stops "for eight
     full minutes"; Rung 2 says "For six minutes the thermometer stays at
     0 °C". Two different set-ups, and a student will read them as one.
...
LESSON = {
    ...
    # ── framing ─────────────────────────────────────────────────────────────
    "big_question": "Put ice on a hot ring and the temperature climbs. Then, "
                    "for eight full minutes, it stops climbing — while the "
                    "flame is still on. Where is that energy going?",
