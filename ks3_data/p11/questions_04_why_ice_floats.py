...
QUESTIONS = [
    ...
    },
    {
        ...
        "options": [
            {"text": "It floats, the way ice floats on water",
             "correct": False,
             "why": "Wax is an ordinary substance: the solid is denser than "
                    "the melt, so it sinks."},
            {"text": "It stays where it is put, because both are wax",
             "correct": False,
            ...
            {"text": "It sinks, because solid wax is denser than melted wax",
             "correct": True},
            {"text": "It dissolves into the melt at once", "correct": False,
    ...
    },
    {
        ...
        "options": [
            {"text": "The molecules themselves get bigger", "correct": False,
             "why": "The molecules are exactly the same size before and "
                    "after. What changes is how far apart they sit."},
            {"text": "Air is trapped between the molecules and pushes them "
                     "apart", "correct": False,
             "why": "Pure bubble-free ice still floats. The expansion happens "
                    "with no air at all."},
            {"text": "The molecules gain mass as they cool", "correct": False,
             "why": "Nothing gains mass. The mass is unchanged; only the "
                    "volume moves."},
    ...
    },
    {
        ...
        "options": [
            {"text": "The ice makes new energy as it forms", "correct": False,
            ...
            {"text": "The ice lets the cold air through to the water below",
             ...
             "why": "It does the opposite — it gets in the way, which is what "
                    "protects the water."},
            {"text": "The ice holds the water below at exactly 0 °C",
             "correct": False,
    ...
    },
    {
        ...
        "options": [
            ...
            {"text": "The pond would freeze from the bottom only, and the top "
                     "would stay liquid", "correct": False,
             "why": "The freezing still starts where the water meets the cold "
                    "air, which is at the top."},
            {"text": "The pond would not freeze at all", "correct": False,
