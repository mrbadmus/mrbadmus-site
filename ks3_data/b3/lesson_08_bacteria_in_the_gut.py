        ...
        {"id": "germs-and-simplicity",
         ...
         "statements": [
             {"quote": "Bacteria are germs. Having bacteria inside you means "
                       "you are ill.",
              "answer": "Of the many thousands of bacterial species that live "
                        "on and in humans, the number that reliably cause "
                        "disease is a small minority. The rest are neutral or "
                        "useful, and the useful ones are doing work you "
                        "cannot do without: about a tenth of the energy some "
                        "people get from their food comes from bacteria "
                        "fermenting fibre, and your entire supply of vitamin "
                        "K is made by bacteria in your own large intestine. "
                        "The word germ is not a biological category at all — "
                        "it is a word for “microorganism I do not want here”, "
                        "and the here matters more than the what. "
                        "<em>E. coli</em> lives harmlessly in almost every "
                        "human large intestine; the same species in your "
                        "bladder is a urinary infection and in your blood it "
                        "can kill you. Nothing about the bacterium changed."},
