# L13 · Series and parallel circuits · SYSTEM

Inventory of `ks4-physics-6.2.2-series-parallel-circuits.dc.html`, measured in headless Chrome via `docs/ks4/pilot-inventory/measure_design.py` (25 Sep 2026). Method, widths, routes and standing law: see `README.md` in this folder — not restated here. AQA Physics 6.2.2.
...
**Line-up (NOTES-KS4-pilot.md §7):** Exam hook with drawn circuit → Change one part bench → rules sort → equation → CFIFA → ladder r4 6-mark (household wiring).

⚠️ **Misconception placement:** the confront opens at 'add a branch' inside the bench itself (NOTES §10.5 names 'L13 add a branch' explicitly) — no standalone #s-think section, confirmed against this page's source (no ks3-misconception class present). §10.11 also names this lesson: the AQA open switch beside the battery is drawn closed only once 'Close the switch' is pressed, drawn open in the Before circuit.
...
|---|---|---|---|---|---|
| 1 | `—` | chrome | AQA Physics 6.2.2 · System | 65 | 160,107,960,480 |
| 2 | `s-hook` | hook | Start here · an exam scenario | 67 | 160,615,960,1276 |
| 3 | `—` | — |  | 0 | 160,1890,960,0 |
| 4 | `—` | explainer |  | 76 | 160,1918,736,213 |
| 5 | `s-bench` | practical | The circuit bench · change one part · change 1 of 4 | 67 | 160,2159,960,896 |
| 6 | `s-rules` | check | Sort the rules | 95 | 160,3084,960,589 |
| 7 | `s-equation` | equation | Equations | 78 | 160,3700,960,334 |
| 8 | `s-calc` | worked-example | Worked example · CFIFA · one step at a time | 122 | 160,4063,960,1297 |
| 9 | `—` | keyword | Command words in this lesson | 35 | 160,5388,960,243 |
| 10 | `—` | — |  | 24 | 160,5659,960,131 |
| 11 | `—` | explainer |  | 50 | 160,5817,960,170 |
| 12 | `s-ladder` | ladder | Extended response | 425 | 160,6015,960,2684 |
| 13 | `s-keynote` | key-note |  | 95 | 160,8734,960,484 |
| 14 | `—` | question-bank | Practice set · Triple Higher | 139 | 160,9252,960,801 |
| 15 | `—` | — |  | 71 | 160,10087,960,436 |

**Flagship (§7):** `#s-bench` — Change one part bench (4 successive changes: R2 -> 20 ohm; rewire in parallel; add a branch; break a branch; predict both meters, then close the switch).
...
|---|---|---|---|---|---|
| TH | 15 | 4 | 425 | 6 | clean |
| CF | 15 | 4 | 425 | (TH only measured) | not swept (1280 only) |
| CH | 15 | 4 | 425 | (TH only measured) | not swept (1280 only) |
| TF | 15 | 4 | 425 | (TH only measured) | not swept (1280 only) |
...
| Width | Rail | Overflow |
|---|---|---|
| 1280 | side hidden · top hidden (scrollY=0), **visible after scroll** ('0 of 5 done Two resistors, one battery') | clean |
| 1340 | side visible (5 nodes) · top hidden (CSS, >=1340) | clean |
| 820 | side hidden · top hidden (scrollY=0), **visible after scroll** ('0 of 5 done Two resistors, one battery') | clean |
| 390 | side hidden · top hidden (scrollY=0), **visible after scroll** ('0 of 5 done Two resistors, one battery') | clean |
| 360 | side hidden · top hidden (scrollY=0), **visible after scroll** ('0 of 5 done Two resistors, one battery') | clean |
...
**Keyboard (1280):** 60 focusable controls, 0 with `tabindex="-1"` (none found on this lesson) — every control is a real `<button>`/`<select>`/`<textarea>`, matching NOTES §2's 'all controls are real buttons, selects, ranges or inputs: keyboard-complete'.
...
| commit | `"Instrument Sans", system-ui, sans-serif` · 22px · 700 · rgb(34, 30, 27) · rgba(0, 0, 0, 0) · 0px none rgb(34, 30, 27) · radius 0px · pad 0px · shadow none  
  box: x192 y1491 w896 h59 | `"Instrument Sans", system-ui, sans-serif` · 22px · 700 · rgb(243, 236, 224) · rgba(0, 0, 0, 0) · 0px none rgb(243, 236, 224) · radius 0px · pad 0px · shadow none  
  box: x192 y1491 w896 h59 |
| option_resting | `"Instrument Sans", system-ui, sans-serif` · 18px · 600 · rgb(34, 30, 27) · rgb(251, 243, 230) · 2px solid rgb(221, 207, 182) · radius 16px · pad 16px 18px · shadow none  
  box: x192 y1566 w896 h65 | `"Instrument Sans", system-ui, sans-serif` · 18px · 600 · rgb(243, 236, 224) · rgb(22, 18, 14) · 2px solid rgb(79, 68, 58) · radius 16px · pad 16px 18px · shadow none  
  box: x192 y1566 w896 h65 |
...
| key_fact_card | `"Instrument Sans", system-ui, sans-serif` · 19px · 400 · rgb(34, 30, 27) · rgb(255, 252, 245) · 2px solid rgb(34, 30, 27) · radius 20px · pad 18px 22px · shadow rgb(228, 87, 46) 5px 5px 0px 0px  
  box: x160 y5659 w960 h131 | `"Instrument Sans", system-ui, sans-serif` · 19px · 400 · rgb(243, 236, 224) · rgb(31, 26, 21) · 2px solid rgb(243, 236, 224) · radius 20px · pad 18px 22px · shadow rgb(240, 122, 78) 5px 5px 0px 0px  
  box: x160 y5659 w960 h131 |
...
| ladder_rung_header | `"Bricolage Grotesque", system-ui, sans-serif` · 36px · 800 · rgb(34, 30, 27) · rgba(0, 0, 0, 0) · 0px none rgb(34, 30, 27) · radius 0px · pad 0px · shadow none  
  box: x195 y6050 w825 h58 | `"Bricolage Grotesque", system-ui, sans-serif` · 36px · 800 · rgb(243, 236, 224) · rgba(0, 0, 0, 0) · 0px none rgb(243, 236, 224) · radius 0px · pad 0px · shadow none  
  box: x195 y6050 w825 h58 |
...
| key_note_card | `"Instrument Sans", system-ui, sans-serif` · 19px · 400 · rgb(34, 30, 27) · rgba(0, 0, 0, 0) · 0px none rgb(34, 30, 27) · radius 0px · pad 0px · shadow none  
  box: x160 y8734 w960 h484 | `"Instrument Sans", system-ui, sans-serif` · 19px · 400 · rgb(243, 236, 224) · rgba(0, 0, 0, 0) · 0px none rgb(243, 236, 224) · radius 0px · pad 0px · shadow none  
  box: x160 y8734 w960 h484 |
| end_prev_next | `"Instrument Sans", system-ui, sans-serif` · 18px · 600 · rgb(169, 52, 17) · rgba(0, 0, 0, 0) · 0px none rgb(169, 52, 17) · radius 0px · pad 0px · shadow none  
  box: x184 y10150 w202 h29 | `"Instrument Sans", system-ui, sans-serif` · 18px · 600 · rgb(255, 158, 120) · rgba(0, 0, 0, 0) · 0px none rgb(255, 158, 120) · radius 0px · pad 0px · shadow none  
  box: x184 y10150 w202 h29 |
...
| # | Trigger | Observed |
|---|---|---|
| 1 | Click #s-hook's first option | reveal text: '\n      Locked in. Check it against the bench below.\n      In series, both resistors carry the same current, 1 A here. V = I R, so the larger resistance takes the larger share: 4 V across the 4 Ω and 8 V across the 8 Ω, adding up to the battery’s 12 V.\n    ' |
...
| 5 | Click #s-ladder rung 1's first option | feedback: 'Not this time. Parallel circuits never increase voltage beyond the supply.' (class `ks3-feedback is-wrong`) |
...
- **Misconception placement, this lesson:** the confront opens at 'add a branch' inside the bench itself (NOTES §10.5 names 'L13 add a branch' explicitly) — no standalone #s-think section, confirmed against this page's source (no ks3-misconception class present). §10.11 also names this lesson: the AQA open switch beside the battery is drawn closed only once 'Close the switch' is pressed, drawn open in the Before circuit.
...
- **Relevant NOTES §9 science flags for this lesson:** #12, #14, #15, #18, #21, #22 — see `NOTES-KS4-pilot.md` for the AQA-sourced text of each; not restated here since they are the examiners' remit (§4.2 of the run brief), not this inventory's.

Screenshots (Triple Higher, light): `$MRB_SHOTS/design/series-parallel-circuits-1280.png`, `$MRB_SHOTS/design/series-parallel-circuits-360.png`.
