# L10 · Giant covalent structures · CONTRAST

Inventory of `ks4-chemistry-5.2.2.6-giant-covalent-structures.dc.html`, measured in headless Chrome via `docs/ks4/pilot-inventory/measure_design.py` (25 Sep 2026). Method, widths, routes and standing law: see `README.md` in this folder — not restated here. AQA Chemistry 5.2.3.3 (graphene/fullerenes) + 5.2.2.6.
...
**Line-up (NOTES-KS4-pilot.md §7):** Hook (drill bit and pencil) → Diamond/graphite A/B → spot-the-flaw (graphite != metal) → graphene/C60/nanotube sort (core, untagged) → ladder r4 6-mark banker No.2.

⚠️ §10.10 names THIS lesson specifically: the diamond/graphite comparison used to be an `<sc-for>` inside `<tbody>`, which the HTML parser moves out of the table, logging unresolved `{{ r.label }}` / `{{ r.d }}` / `{{ r.g }}` holes. It is now card rows with ARIA table roles kept, wrapping under 480px. Confirmed clean here: 0 console errors, 0 overflow at 360/390 in this run.
...
|---|---|---|---|---|---|
| 1 | `—` | chrome | AQA Chemistry 5.2.2.6 · 5.2.3.1–5.2.3.3 · Contrast | 58 | 160,107,960,483 |
| 2 | `s-hook` | hook | Start here | 106 | 160,619,960,621 |
| 3 | `—` | — |  | 0 | 160,1239,960,0 |
| 4 | `—` | explainer |  | 81 | 160,1267,736,245 |
| 5 | `s-compare` | comparison | Diamond against graphite | 61 | 160,1540,960,1086 |
| 6 | `s-think` | misconception | Think again | 85 | 160,2654,960,579 |
| 7 | `—` | explainer |  | 69 | 160,3261,736,210 |
| 8 | `s-sort` | check | Sort it | 102 | 160,3499,960,674 |
| 9 | `—` | keyword | Command words in this lesson | 37 | 160,4201,960,268 |
| 10 | `—` | — |  | 32 | 160,4497,960,157 |
| 11 | `—` | explainer |  | 57 | 160,4682,960,194 |
| 12 | `s-ladder` | ladder | Extended response | 365 | 160,4904,960,2548 |
| 13 | `s-keynote` | key-note |  | 111 | 160,7486,960,574 |
| 14 | `—` | question-bank | Practice set · Triple Higher | 319 | 160,8094,960,1443 |
| 15 | `—` | — |  | 95 | 160,9571,960,487 |

**Flagship (§7):** `#s-compare` — Diamond/graphite A/B (per structure, predict bonds per atom, conductivity, hardness and melting point; comparison table fills as you go).
...
|---|---|---|---|---|---|
| TH | 15 | 4 | 365 | 6 | clean |
| CF | 15 | 4 | 322 | (TH only measured) | not swept (1280 only) |
| CH | 15 | 4 | 365 | (TH only measured) | not swept (1280 only) |
| TF | 15 | 4 | 322 | (TH only measured) | not swept (1280 only) |
...
| Width | Rail | Overflow |
|---|---|---|
| 1280 | side hidden · top hidden (scrollY=0), **visible after scroll** ('0 of 5 done Drill bit and pencil') | clean |
| 1340 | side visible (5 nodes) · top hidden (CSS, >=1340) | clean |
| 820 | side hidden · top hidden (scrollY=0), **visible after scroll** ('0 of 5 done Drill bit and pencil') | clean |
| 390 | side hidden · top hidden (scrollY=0), **visible after scroll** ('0 of 5 done Drill bit and pencil') | clean |
| 360 | side hidden · top hidden (scrollY=0), **visible after scroll** ('0 of 5 done Drill bit and pencil') | clean |
...
| misconception_panel | `"Instrument Sans", system-ui, sans-serif` · 19px · 400 · rgb(34, 30, 27) · rgb(255, 243, 212) · 2px solid rgb(34, 30, 27) · radius 28px · pad 30px · shadow rgb(34, 30, 27) 5px 5px 0px 0px  
  box: x160 y2654 w960 h579 | `"Instrument Sans", system-ui, sans-serif` · 19px · 400 · rgb(243, 236, 224) · rgb(51, 41, 15) · 2px solid rgb(243, 236, 224) · radius 28px · pad 30px · shadow rgb(243, 236, 224) 5px 5px 0px 0px  
  box: x160 y2654 w960 h579 |
| key_fact_card | `"Instrument Sans", system-ui, sans-serif` · 19px · 400 · rgb(34, 30, 27) · rgb(255, 252, 245) · 2px solid rgb(34, 30, 27) · radius 20px · pad 18px 22px · shadow rgb(228, 87, 46) 5px 5px 0px 0px  
  box: x160 y4497 w960 h157 | `"Instrument Sans", system-ui, sans-serif` · 19px · 400 · rgb(243, 236, 224) · rgb(31, 26, 21) · 2px solid rgb(243, 236, 224) · radius 20px · pad 18px 22px · shadow rgb(240, 122, 78) 5px 5px 0px 0px  
  box: x160 y4497 w960 h157 |
| badge_pill | `"DM Mono", ui-monospace, monospace` · 13px · 500 · rgb(34, 30, 27) · rgba(0, 0, 0, 0) · 2px solid rgb(34, 30, 27) · radius 99px · pad 4px 11px · shadow none  
  box: x160 y450 w172 h33 | `"DM Mono", ui-monospace, monospace` · 13px · 500 · rgb(243, 236, 224) · rgba(0, 0, 0, 0) · 2px solid rgb(243, 236, 224) · radius 99px · pad 4px 11px · shadow none  
  box: x160 y450 w172 h33 |
| ladder_rung_header | `"Bricolage Grotesque", system-ui, sans-serif` · 36px · 800 · rgb(34, 30, 27) · rgba(0, 0, 0, 0) · 0px none rgb(34, 30, 27) · radius 0px · pad 0px · shadow none  
  box: x195 y4939 w825 h58 | `"Bricolage Grotesque", system-ui, sans-serif` · 36px · 800 · rgb(243, 236, 224) · rgba(0, 0, 0, 0) · 0px none rgb(243, 236, 224) · radius 0px · pad 0px · shadow none  
  box: x195 y4939 w825 h58 |
...
| key_note_card | `"Instrument Sans", system-ui, sans-serif` · 19px · 400 · rgb(34, 30, 27) · rgba(0, 0, 0, 0) · 0px none rgb(34, 30, 27) · radius 0px · pad 0px · shadow none  
  box: x160 y7486 w960 h574 | `"Instrument Sans", system-ui, sans-serif` · 19px · 400 · rgb(243, 236, 224) · rgba(0, 0, 0, 0) · 0px none rgb(243, 236, 224) · radius 0px · pad 0px · shadow none  
  box: x160 y7486 w960 h574 |
| end_prev_next | `"Instrument Sans", system-ui, sans-serif` · 18px · 600 · rgb(169, 52, 17) · rgba(0, 0, 0, 0) · 0px none rgb(169, 52, 17) · radius 0px · pad 0px · shadow none  
  box: x184 y9635 w163 h29 | `"Instrument Sans", system-ui, sans-serif` · 18px · 600 · rgb(255, 158, 120) · rgba(0, 0, 0, 0) · 0px none rgb(255, 158, 120) · radius 0px · pad 0px · shadow none  
  box: x184 y9635 w163 h29 |
...
| reveal panel (`[data-arrive]`, after hook commit) | `"Instrument Sans", system-ui, sans-serif` · 19px · 400 · rgb(34, 30, 27) · rgb(252, 231, 222) · 2px solid rgb(228, 87, 46) · radius 18px · pad 18px 20px · shadow none  
  box: x192 y777 w896 h143 | *(dark not separately captured for state-dependent nodes — see README limitation)* |
...
| # | Trigger | Observed |
|---|---|---|
| 1 | Click #s-hook's first option | reveal text: '\n      Locked in. Count the bonds below and test it.\n      The atoms are the same; the bonding is not. How many bonds each carbon forms decides whether the structure is a rigid 3D network or stacked layers, and whether any electrons are left free.\n    ' |
...
| 3 | Click a button inside the flagship (`#s-compare`) | clicked=True; new text after click: '(no new tail text — state likely changed via attributes/marks rather than appended prose; see screenshot)' |
| 4 | Tap a card then a bin in the sort (`10` buttons found) | interacted=True |
| 5 | Click #s-ladder rung 1's first option | feedback: 'Not this time. Diamond is entirely covalent and contains no ions; there are no ionic bonds to break.' (class `ks3-feedback is-wrong`) |
...
- **Route-tag / build scope, this lesson:** §10.10 names THIS lesson specifically: the diamond/graphite comparison used to be an `<sc-for>` inside `<tbody>`, which the HTML parser moves out of the table, logging unresolved `{{ r.label }}` / `{{ r.d }}` / `{{ r.g }}` holes. It is now card rows with ARIA table roles kept, wrapping under 480px. Confirmed clean here: 0 console errors, 0 overflow at 360/390 in this run.
...
- **Relevant NOTES §9 science flags for this lesson:** #1, #18 — see `NOTES-KS4-pilot.md` for the AQA-sourced text of each; not restated here since they are the examiners' remit (§4.2 of the run brief), not this inventory's.

Screenshots (Triple Higher, light): `$MRB_SHOTS/design/giant-covalent-structures-1280.png`, `$MRB_SHOTS/design/giant-covalent-structures-360.png`.
