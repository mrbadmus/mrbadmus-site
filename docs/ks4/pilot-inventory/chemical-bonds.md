# L1 · Chemical bonds · CLASSIFY

Inventory of `ks4-chemistry-5.2.1.1-chemical-bonds.dc.html`, measured in headless Chrome via `docs/ks4/pilot-inventory/measure_design.py` (25 Sep 2026). Method, widths, routes and standing law: see `README.md` in this folder — not restated here. AQA Chemistry 5.2.1.1.
...
**Line-up (NOTES-KS4-pilot.md §7):** Hook (Na vs H with Cl) → Bond decider flagship → spot-the-flaw (ice melting ≠ weak bonds) → 8-card Ks4Sort → ladder (data table P/Q/R).
...
|---|---|---|---|---|---|
| 1 | `—` | chrome | AQA Chemistry 5.2.1.1 · Classify | 45 | 160,107,960,416 |
| 2 | `s-hook` | hook | Start here | 104 | 160,551,960,651 |
| 3 | `—` | — |  | 0 | 160,1202,960,0 |
| 4 | `—` | explainer |  | 114 | 160,1230,736,333 |
| 5 | `s-decider` | check | The bond decider | 76 | 160,1591,960,573 |
| 6 | `—` | explainer |  | 87 | 160,2192,736,245 |
| 7 | `s-think` | misconception | Think again | 92 | 160,2465,960,549 |
| 8 | `s-sort` | check | Sort it | 60 | 160,3042,960,454 |
| 9 | `—` | keyword | Command words in this lesson | 42 | 160,3525,960,243 |
| 10 | `—` | — |  | 25 | 160,3796,960,127 |
| 11 | `—` | explainer |  | 45 | 160,3951,960,164 |
| 12 | `s-ladder` | ladder | Extended response | 343 | 160,4143,960,2614 |
| 13 | `s-keynote` | key-note |  | 97 | 160,6790,960,484 |
| 14 | `—` | question-bank | Practice set · Triple Higher | 269 | 160,7309,960,1426 |
| 15 | `—` | — |  | 92 | 160,8769,960,476 |

**Flagship (§7):** `#s-decider` — The bond decider (13-element tray; pair → predict ionic/covalent/metallic → chamber draws dot-and-cross, formula or electron sea).
...
|---|---|---|---|---|---|
| TH | 15 | 4 | 343 | 6 | clean |
| CF | 15 | 4 | 343 | (TH only measured) | not swept (1280 only) |
| CH | 15 | 4 | 343 | (TH only measured) | not swept (1280 only) |
| TF | 15 | 4 | 343 | (TH only measured) | not swept (1280 only) |
...
| Width | Rail | Overflow |
|---|---|---|
| 1280 | side hidden · top hidden (scrollY=0), **visible after scroll** ('0 of 5 done Two partners') | clean |
| 1340 | side visible (5 nodes) · top hidden (CSS, >=1340) | clean |
| 820 | side hidden · top hidden (scrollY=0), **visible after scroll** ('0 of 5 done Two partners') | clean |
| 390 | side hidden · top hidden (scrollY=0), **visible after scroll** ('0 of 5 done Two partners') | clean |
| 360 | side hidden · top hidden (scrollY=0), **visible after scroll** ('0 of 5 done Two partners') | clean |
...
**Keyboard (1280):** 76 focusable controls, 0 with `tabindex="-1"` (none found on this lesson) — every control is a real `<button>`/`<select>`/`<textarea>`, matching NOTES §2's 'all controls are real buttons, selects, ranges or inputs: keyboard-complete'.
...
| commit | `"Instrument Sans", system-ui, sans-serif` · 22px · 700 · rgb(34, 30, 27) · rgba(0, 0, 0, 0) · 0px none rgb(34, 30, 27) · radius 0px · pad 0px · shadow none  
  box: x192 y832 w896 h30 | `"Instrument Sans", system-ui, sans-serif` · 22px · 700 · rgb(243, 236, 224) · rgba(0, 0, 0, 0) · 0px none rgb(243, 236, 224) · radius 0px · pad 0px · shadow none  
  box: x192 y832 w896 h30 |
| option_resting | `"Instrument Sans", system-ui, sans-serif` · 18px · 600 · rgb(34, 30, 27) · rgb(251, 243, 230) · 2px solid rgb(221, 207, 182) · radius 16px · pad 16px 18px · shadow none  
  box: x192 y878 w896 h65 | `"Instrument Sans", system-ui, sans-serif` · 18px · 600 · rgb(243, 236, 224) · rgb(22, 18, 14) · 2px solid rgb(79, 68, 58) · radius 16px · pad 16px 18px · shadow none  
  box: x192 y878 w896 h65 |
| misconception_panel | `"Instrument Sans", system-ui, sans-serif` · 19px · 400 · rgb(34, 30, 27) · rgb(255, 243, 212) · 2px solid rgb(34, 30, 27) · radius 28px · pad 30px · shadow rgb(34, 30, 27) 5px 5px 0px 0px  
  box: x160 y2465 w960 h549 | `"Instrument Sans", system-ui, sans-serif` · 19px · 400 · rgb(243, 236, 224) · rgb(51, 41, 15) · 2px solid rgb(243, 236, 224) · radius 28px · pad 30px · shadow rgb(243, 236, 224) 5px 5px 0px 0px  
  box: x160 y2465 w960 h549 |
| key_fact_card | `"Instrument Sans", system-ui, sans-serif` · 19px · 400 · rgb(34, 30, 27) · rgb(255, 252, 245) · 2px solid rgb(34, 30, 27) · radius 20px · pad 18px 22px · shadow rgb(228, 87, 46) 5px 5px 0px 0px  
  box: x160 y3796 w960 h127 | `"Instrument Sans", system-ui, sans-serif` · 19px · 400 · rgb(243, 236, 224) · rgb(31, 26, 21) · 2px solid rgb(243, 236, 224) · radius 20px · pad 18px 22px · shadow rgb(240, 122, 78) 5px 5px 0px 0px  
  box: x160 y3796 w960 h127 |
...
| ladder_rung_header | `"Bricolage Grotesque", system-ui, sans-serif` · 36px · 800 · rgb(34, 30, 27) · rgba(0, 0, 0, 0) · 0px none rgb(34, 30, 27) · radius 0px · pad 0px · shadow none  
  box: x195 y4178 w825 h58 | `"Bricolage Grotesque", system-ui, sans-serif` · 36px · 800 · rgb(243, 236, 224) · rgba(0, 0, 0, 0) · 0px none rgb(243, 236, 224) · radius 0px · pad 0px · shadow none  
  box: x195 y4178 w825 h58 |
...
| key_note_card | `"Instrument Sans", system-ui, sans-serif` · 19px · 400 · rgb(34, 30, 27) · rgba(0, 0, 0, 0) · 0px none rgb(34, 30, 27) · radius 0px · pad 0px · shadow none  
  box: x160 y6790 w960 h484 | `"Instrument Sans", system-ui, sans-serif` · 19px · 400 · rgb(243, 236, 224) · rgba(0, 0, 0, 0) · 0px none rgb(243, 236, 224) · radius 0px · pad 0px · shadow none  
  box: x160 y6790 w960 h484 |
| end_prev_next | `"Instrument Sans", system-ui, sans-serif` · 18px · 600 · rgb(169, 52, 17) · rgba(0, 0, 0, 0) · 0px none rgb(169, 52, 17) · radius 0px · pad 0px · shadow none  
  box: x184 y8832 w198 h29 | `"Instrument Sans", system-ui, sans-serif` · 18px · 600 · rgb(255, 158, 120) · rgba(0, 0, 0, 0) · 0px none rgb(255, 158, 120) · radius 0px · pad 0px · shadow none  
  box: x184 y8832 w198 h29 |
...
| reveal panel (`[data-arrive]`, after hook commit) | `"Instrument Sans", system-ui, sans-serif` · 19px · 400 · rgb(34, 30, 27) · rgb(252, 231, 222) · 2px solid rgb(228, 87, 46) · radius 18px · pad 18px 20px · shadow none  
  box: x192 y778 w896 h204 | *(dark not separately captured for state-dependent nodes — see README limitation)* |
...
| # | Trigger | Observed |
|---|---|---|
| 1 | Click #s-hook's first option | reveal text: '\n      Locked in. You are on the idea the whole unit rests on.\n      Sodium is a metal; hydrogen is not, even though it sits at the top of the table above sodium. A metal gives its electron to chlorine and the two become oppositely charged ions, locked into a crystal. Hydrogen and chlorine are both non-metals: they share a pair of electrons and make small separate molecules that drift apart as a gas.\n    ' |
...
| 3 | Click a button inside the flagship (`#s-decider`) | clicked=True; new text after click: '(no new tail text — state likely changed via attributes/marks rather than appended prose; see screenshot)' |
| 4 | Tap a card then a bin in the sort (`12` buttons found) | interacted=True |
| 5 | Click #s-ladder rung 1's first option | feedback: 'Not this time. Pure water barely conducts; where it does, it is due to tiny amounts of ions, not because it is ionic.' (class `ks3-feedback is-wrong`) |
...
- **Relevant NOTES §9 science flags for this lesson:** #16, #17, #18 — see `NOTES-KS4-pilot.md` for the AQA-sourced text of each; not restated here since they are the examiners' remit (§4.2 of the run brief), not this inventory's.

Screenshots (Triple Higher, light): `$MRB_SHOTS/design/chemical-bonds-1280.png`, `$MRB_SHOTS/design/chemical-bonds-360.png`.
