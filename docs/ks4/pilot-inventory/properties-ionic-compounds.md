# L7 · Properties of ionic compounds · CONTRAST

Inventory of `ks4-chemistry-5.2.2.3-properties-ionic-compounds.dc.html`, measured in headless Chrome via `docs/ks4/pilot-inventory/measure_design.py` (25 Sep 2026). Method, widths, routes and standing law: see `README.md` in this folder — not restated here. AQA Chemistry 5.2.2.3.
...
**Line-up (NOTES-KS4-pilot.md §7):** Hook (probes in salt) → Side-by-side beakers → spot-the-flaw (electrons flow) → linked-comparison Ks4Chain → Be the examiner (mark a 1/3 answer) → ladder r4 6-mark banker No.1.
...
|---|---|---|---|---|---|
| 1 | `—` | chrome | AQA Chemistry 5.2.2.3 · Contrast | 52 | 160,107,960,485 |
| 2 | `s-hook` | hook | Start here | 98 | 160,621,960,621 |
| 3 | `—` | — |  | 0 | 160,1241,960,0 |
| 4 | `—` | explainer |  | 77 | 160,1269,736,210 |
| 5 | `s-bench` | practical | Side by side · solid against the rest | 64 | 160,1507,960,739 |
| 6 | `s-think` | misconception | Think again | 76 | 160,2274,960,520 |
| 7 | `s-chain` | comparison | Linked comparison | 152 | 160,2823,960,812 |
| 8 | `s-examiner` | extended-response | Be the examiner · 3 marks | 75 | 160,3662,960,689 |
| 9 | `—` | keyword | Command words in this lesson | 38 | 160,4379,960,243 |
| 10 | `—` | — |  | 30 | 160,4650,960,127 |
| 11 | `—` | explainer |  | 45 | 160,4805,960,164 |
| 12 | `s-ladder` | ladder | Extended response | 356 | 160,4997,960,2626 |
| 13 | `s-keynote` | key-note |  | 108 | 160,7657,960,544 |
| 14 | `—` | question-bank | Practice set · Triple Higher | 291 | 160,8235,960,1447 |
| 15 | `—` | — |  | 94 | 160,9716,960,436 |

**Flagship (§7):** `#s-bench` — Side-by-side beakers (solid: fixed lattice, bulb off; molten/solution: ions drift to opposite electrodes, bulb lit; predict each).
...
|---|---|---|---|---|---|
| TH | 15 | 4 | 356 | 6 | clean |
| CF | 15 | 4 | 330 | (TH only measured) | not swept (1280 only) |
| CH | 15 | 4 | 356 | (TH only measured) | not swept (1280 only) |
| TF | 15 | 4 | 330 | (TH only measured) | not swept (1280 only) |
...
| Width | Rail | Overflow |
|---|---|---|
| 1280 | side hidden · top hidden (scrollY=0), **visible after scroll** ('0 of 6 done Salt and a bulb') | clean |
| 1340 | side visible (6 nodes) · top hidden (CSS, >=1340) | clean |
| 820 | side hidden · top hidden (scrollY=0), **visible after scroll** ('0 of 6 done Salt and a bulb') | clean |
| 390 | side hidden · top hidden (scrollY=0), **visible after scroll** ('0 of 6 done Salt and a bulb') | clean |
| 360 | side hidden · top hidden (scrollY=0), **visible after scroll** ('0 of 6 done Salt and a bulb') | clean |
...
**Keyboard (1280):** 66 focusable controls, 0 with `tabindex="-1"` (none found on this lesson) — every control is a real `<button>`/`<select>`/`<textarea>`, matching NOTES §2's 'all controls are real buttons, selects, ranges or inputs: keyboard-complete'.
...
| commit | `"Instrument Sans", system-ui, sans-serif` · 22px · 700 · rgb(34, 30, 27) · rgba(0, 0, 0, 0) · 0px none rgb(34, 30, 27) · radius 0px · pad 0px · shadow none  
  box: x192 y872 w896 h30 | `"Instrument Sans", system-ui, sans-serif` · 22px · 700 · rgb(243, 236, 224) · rgba(0, 0, 0, 0) · 0px none rgb(243, 236, 224) · radius 0px · pad 0px · shadow none  
  box: x192 y872 w896 h30 |
| option_resting | `"Instrument Sans", system-ui, sans-serif` · 18px · 600 · rgb(34, 30, 27) · rgb(251, 243, 230) · 2px solid rgb(221, 207, 182) · radius 16px · pad 16px 18px · shadow none  
  box: x192 y917 w896 h65 | `"Instrument Sans", system-ui, sans-serif` · 18px · 600 · rgb(243, 236, 224) · rgb(22, 18, 14) · 2px solid rgb(79, 68, 58) · radius 16px · pad 16px 18px · shadow none  
  box: x192 y917 w896 h65 |
| misconception_panel | `"Instrument Sans", system-ui, sans-serif` · 19px · 400 · rgb(34, 30, 27) · rgb(255, 243, 212) · 2px solid rgb(34, 30, 27) · radius 28px · pad 30px · shadow rgb(34, 30, 27) 5px 5px 0px 0px  
  box: x160 y2274 w960 h520 | `"Instrument Sans", system-ui, sans-serif` · 19px · 400 · rgb(243, 236, 224) · rgb(51, 41, 15) · 2px solid rgb(243, 236, 224) · radius 28px · pad 30px · shadow rgb(243, 236, 224) 5px 5px 0px 0px  
  box: x160 y2274 w960 h520 |
| key_fact_card | `"Instrument Sans", system-ui, sans-serif` · 19px · 400 · rgb(34, 30, 27) · rgb(255, 252, 245) · 2px solid rgb(34, 30, 27) · radius 20px · pad 18px 22px · shadow rgb(228, 87, 46) 5px 5px 0px 0px  
  box: x160 y4650 w960 h127 | `"Instrument Sans", system-ui, sans-serif` · 19px · 400 · rgb(243, 236, 224) · rgb(31, 26, 21) · 2px solid rgb(243, 236, 224) · radius 20px · pad 18px 22px · shadow rgb(240, 122, 78) 5px 5px 0px 0px  
  box: x160 y4650 w960 h127 |
| badge_pill | `"DM Mono", ui-monospace, monospace` · 13px · 500 · rgb(34, 30, 27) · rgba(0, 0, 0, 0) · 2px solid rgb(34, 30, 27) · radius 99px · pad 4px 11px · shadow none  
  box: x160 y452 w172 h33 | `"DM Mono", ui-monospace, monospace` · 13px · 500 · rgb(243, 236, 224) · rgba(0, 0, 0, 0) · 2px solid rgb(243, 236, 224) · radius 99px · pad 4px 11px · shadow none  
  box: x160 y452 w172 h33 |
| ladder_rung_header | `"Bricolage Grotesque", system-ui, sans-serif` · 36px · 800 · rgb(34, 30, 27) · rgba(0, 0, 0, 0) · 0px none rgb(34, 30, 27) · radius 0px · pad 0px · shadow none  
  box: x195 y5032 w825 h58 | `"Bricolage Grotesque", system-ui, sans-serif` · 36px · 800 · rgb(243, 236, 224) · rgba(0, 0, 0, 0) · 0px none rgb(243, 236, 224) · radius 0px · pad 0px · shadow none  
  box: x195 y5032 w825 h58 |
...
| key_note_card | `"Instrument Sans", system-ui, sans-serif` · 19px · 400 · rgb(34, 30, 27) · rgba(0, 0, 0, 0) · 0px none rgb(34, 30, 27) · radius 0px · pad 0px · shadow none  
  box: x160 y7657 w960 h544 | `"Instrument Sans", system-ui, sans-serif` · 19px · 400 · rgb(243, 236, 224) · rgba(0, 0, 0, 0) · 0px none rgb(243, 236, 224) · radius 0px · pad 0px · shadow none  
  box: x160 y7657 w960 h544 |
| end_prev_next | `"Instrument Sans", system-ui, sans-serif` · 18px · 600 · rgb(169, 52, 17) · rgba(0, 0, 0, 0) · 0px none rgb(169, 52, 17) · radius 0px · pad 0px · shadow none  
  box: x184 y9779 w220 h29 | `"Instrument Sans", system-ui, sans-serif` · 18px · 600 · rgb(255, 158, 120) · rgba(0, 0, 0, 0) · 0px none rgb(255, 158, 120) · radius 0px · pad 0px · shadow none  
  box: x184 y9779 w220 h29 |
...
| # | Trigger | Observed |
|---|---|---|
| 1 | Click #s-hook's first option | reveal text: '\n      Locked in. Test it: set the ions free and see what the bulb does.\n      In the solid, the ions are locked into the lattice. They have charge but they cannot move, so no charge can flow. The bench below lets you free them.\n    ' |
...
| 5 | Click #s-ladder rung 1's first option | feedback: 'Not this time. Solid ionic compounds do contain charged ions; they simply cannot move.' (class `ks3-feedback is-wrong`) |
...
- **Relevant NOTES §9 science flags for this lesson:** #9, #18 — see `NOTES-KS4-pilot.md` for the AQA-sourced text of each; not restated here since they are the examiners' remit (§4.2 of the run brief), not this inventory's.

Screenshots (Triple Higher, light): `$MRB_SHOTS/design/properties-ionic-compounds-1280.png`, `$MRB_SHOTS/design/properties-ionic-compounds-360.png`.
