...
| rule | severity | count |
|---|---|---|
| 1-count | critical | 823 |
| 1-count | major | 28 |
| 1-register | minor | 805 |
| 1-triple-depth | major | 362 |
| 2-example-count | major | 200 |
| 2-practice-absent | major | 214 |
| 2-tier-duplication | major | 94 |
| 3-mistake-first | major | 813 |
| 4-menu | info | 139 |
| 5-tier-integrity | major | 406 |
...
| physics/forces/acceleration | triple | higher | 29 |
...
- `1111000111` × 76 (e.g. biology/combined/foundation/cell-biology/eukaryotes-prokaryotes)
...
- `1111100111` × 16 (e.g. chemistry/combined/higher/quantitative/relative-formula-mass)
