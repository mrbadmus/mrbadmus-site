...
(function() {
  ...
  const INDEX = [
    ...
    {t:'Energy Changes in Systems and SHC',s:'Physics',url:'/combined/higher/physics/energy/energy-changes-systems.html',c:'#4ECDC4'},
    {t:'Power',s:'Physics',url:'/combined/higher/physics/energy/power.html',c:'#4ECDC4'},
    {t:'Energy Transfers in a System',s:'Physics',url:'/combined/higher/physics/energy/energy-transfers-system.html',c:'#4ECDC4'},
    ...
    {t:'Electrical Charge and Current',s:'Physics',url:'/combined/higher/physics/electricity/charge-and-current.html',c:'#4ECDC4'},
    ...
    {t:'Direct and Alternating Current',s:'Physics',url:'/combined/higher/physics/electricity/direct-alternating-current.html',c:'#4ECDC4'},
    {t:'Mains Electricity and Safety',s:'Physics',url:'/combined/higher/physics/electricity/mains-electricity.html',c:'#4ECDC4'},
    {t:'Power in Electrical Circuits',s:'Physics',url:'/combined/higher/physics/electricity/electrical-power.html',c:'#4ECDC4'},
    {t:'Energy Transfers in Appliances',s:'Physics',url:'/combined/higher/physics/electricity/energy-transfers-appliances.html',c:'#4ECDC4'},
    {t:'The National Grid',s:'Physics',url:'/combined/higher/physics/electricity/national-grid.html',c:'#4ECDC4'},
    {t:'Density of Materials',s:'Physics',url:'/combined/higher/physics/particle-model/density.html',c:'#4ECDC4'},
    {t:'Changes of State',s:'Physics',url:'/combined/higher/physics/particle-model/changes-of-state-particle.html',c:'#4ECDC4'},
    {t:'Internal Energy',s:'Physics',url:'/combined/higher/physics/particle-model/internal-energy.html',c:'#4ECDC4'},
    {t:'Temperature Changes and Specific Heat Capacity',s:'Physics',url:'/combined/higher/physics/particle-model/temperature-shc.html',c:'#4ECDC4'},
    {t:'Specific Latent Heat',s:'Physics',url:'/combined/higher/physics/particle-model/specific-latent-heat.html',c:'#4ECDC4'},
    {t:'Particle Motion in Gases and Pressure',s:'Physics',url:'/combined/higher/physics/particle-model/particle-motion-gases.html',c:'#4ECDC4'},
    {t:'Structure of the Atom',s:'Physics',url:'/combined/higher/physics/atomic-structure/structure-of-atom.html',c:'#4ECDC4'},
    ...
    {t:'Development of the Atomic Model',s:'Physics',url:'/combined/higher/physics/atomic-structure/development-atomic-model.html',c:'#4ECDC4'},
    ...
    {t:'Radioactive Contamination and Irradiation',s:'Physics',url:'/combined/higher/physics/atomic-structure/radioactive-contamination.html',c:'#4ECDC4'},
    {t:'Scalar and Vector Quantities',s:'Physics',url:'/combined/higher/physics/forces/scalar-vector.html',c:'#4ECDC4'},
    ...
    {t:'Work Done and Energy Transfer',s:'Physics',url:'/combined/higher/physics/forces/work-done.html',c:'#4ECDC4'},
    ...
    {t:'Acceleration and Motion Graphs',s:'Physics',url:'/combined/higher/physics/forces/acceleration-motion-graphs.html',c:'#4ECDC4'},
    {t:"Newton's Laws of Motion",s:'Physics',url:'/combined/higher/physics/forces/newtons-laws.html',c:'#4ECDC4'},
    {t:'Stopping Distance and Braking',s:'Physics',url:'/combined/higher/physics/forces/stopping-distance.html',c:'#4ECDC4'},
    ...
    {t:'Types of Electromagnetic Waves',s:'Physics',url:'/combined/higher/physics/waves/em-waves-types.html',c:'#4ECDC4'},
    {t:'Properties of Electromagnetic Waves 1',s:'Physics',url:'/combined/higher/physics/waves/em-waves-properties-1.html',c:'#4ECDC4'},
    {t:'Properties of Electromagnetic Waves 2 and Hazards',s:'Physics',url:'/combined/higher/physics/waves/em-waves-properties-2.html',c:'#4ECDC4'},
    {t:'Uses and Applications of EM Waves',s:'Physics',url:'/combined/higher/physics/waves/uses-applications-em.html',c:'#4ECDC4'},
