#!/usr/bin/env python3
"""
Physics subtopics — Combined HIGHER
AQA 8464 Physics — Higher Tier
COMPLETE — 53 subtopics

Includes all Foundation content PLUS:
  - Higher field content on 12 existing subtopics
  - 3 new Higher-only subtopics:
      Forces: momentum
      Magnetism: flemings-left-hand-rule, electric-motors
"""
