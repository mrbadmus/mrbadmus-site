...
## ⚠️ You are in the `b2c/launch` worktree

This file is branch-local scaffolding for MRB-308. On `main`, this README is a
one-line stub, and it should go back to being one when this branch merges —
**do not carry this section onto `main`.** It is here so that whoever opens
this checkout cold knows which half of the work they are holding.
